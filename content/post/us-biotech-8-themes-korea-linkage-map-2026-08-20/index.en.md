...
| Term | Plain meaning |
|---|---|
| **XBI** | An ETF holding US small/mid-cap biotechs. Think of it as **the thermometer of US biotech**. |
...
| **Royalty** | A percentage of sales you **keep receiving** every time the exported drug sells. The highest-quality income in biotech. |
| **CDMO** | A factory that **makes other people's drugs**. Whether the drug succeeds or not, orders mean revenue. |
| **Binary event** | An event whose outcome is **one of two** (trial readout, approval decision). The stock can move tens of percent in a day. |
| **Patent cliff** | When a blockbuster's patent expires and **revenue falls off a cliff**. This fear is the root engine behind biotech M&A. |
...
<svg viewBox="0 0 720 270" width="100%" role="img" aria-label="Patent cliff diagram: revenue collapses at patent expiry, and big pharma fills the gap by acquiring biotechs" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="16" y="26" class="ct" font-size="15" font-weight="700">The patent cliff: why big pharma has to buy biotechs</text>
...
<svg viewBox="0 0 720 470" width="100%" role="img" aria-label="Five-step flow of how a personalized mRNA cancer vaccine works" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="16" y="26" class="mt" font-size="15" font-weight="700">How a personalized mRNA cancer vaccine works (intismeran + Keytruda)</text>
  ...
  <text x="30" y="68" class="mt" font-size="13" font-weight="700">① Take the patient's tumor tissue</text>
  ...
  <text x="30" y="144" class="mt" font-size="13" font-weight="700">② Sequence it to find that patient's own 'targets'</text>
  ...
  <text x="30" y="220" class="mt" font-size="13" font-weight="700">③ Design a patient-specific mRNA carrying those targets</text>
...
|---|---|---|---|---|
| 1 | **SMMT** | ② geopolitics | Price down −56% from highs + **a date-stamped event** (FDA decision 11/14) + improved survival data | PDUFA 11/14 |
| 2 | **VKTX** | ① obesity | Phase 3 enrollment complete + $502M cash + $4.2B market cap. Against Pfizer's $10B deal, it reads as a **takeover candidate** | Multiple Q3 readouts |
| 3 | **AKTS** | ④ RLT | The $8B deal reset valuations + $538M cash. But its own data are far out (early 2027) | Trial start |
...
<svg viewBox="0 0 720 520" width="100%" role="img" aria-label="Quadrant map of 10 Korean linked companies by contract substance and price relative strength" xmlns="http://www.w3.org/2000/svg">
  <style>
...
**Q. Should I buy whenever a licensing headline appears?**
