---
title: "Why Korea Partie 3 : Samsung et SK Hynix, 300 T KRW+ de bénéfices annuels pour rehausser l’économie coréenne"
...
## 1. Le trimestre qui a changé la donne
...
## 2. Pourquoi c'est une histoire d'économie coréenne, pas seulement une histoire de puces

Le marché analyse habituellement Samsung et SK hynix sous trois angles :

| Angle | Question habituelle |
|---|---|
| Actions | Samsung et SK hynix sont-elles encore sous-évaluées par rapport à Nvidia, TSMC et Micron ? |
| Secteur | Les prix du HBM et du DRAM resteront-ils tendus jusqu'en 2027 ? |
| Cycle | Sommes-nous au sommet du cycle mémoire ou au début d'une pénurie durable ? |

Ce sont les bonnes questions pour les investisseurs en semi-conducteurs. Elles sont insuffisantes pour les allocateurs étrangers qui s'intéressent à la Corée.
...
La direction importe néanmoins : la marge de manœuvre budgétaire de la Corée devient de plus en plus sensible au cycle de la mémoire IA. Lorsque le cycle est favorable, le gouvernement dispose de davantage d'options :

- émettre moins de dette ;
- financer des budgets supplémentaires avec moins de pression sur le marché obligataire ;
- investir dans les réseaux électriques, l'eau, les usines de puces et les clusters de recherche ;
- soutenir la demande intérieure sans aggraver immédiatement les tensions budgétaires.

Pour les investisseurs étrangers, cela change la manière dont la Corée doit être analysée. Un vivier de bénéfices plus solide dans les semi-conducteurs peut comprimer la prime de risque souverain, améliorer la flexibilité budgétaire et soutenir le won, même si le bénéfice est inégalement réparti.

---

## 4. Deuxième canal de transmission : le revenu des ménages

Le deuxième canal de transmission est le revenu du travail.

SK hynix a accepté d'allouer 10 % de son bénéfice opérationnel annuel à des primes de performance pour ses salariés et a supprimé le plafond précédent. Des médias coréens et internationaux ont rapporté que, dans les scénarios optimistes de bénéfices, les primes moyennes par employé de SK hynix pourraient atteindre plusieurs centaines de millions de wons.

Samsung Electronics subit une pression syndicale pour se rapprocher de ce modèle. Son syndicat a réclamé une formule d'intéressement plus généreuse, tandis que la direction a évoqué des structures de rémunération indexées sur le bénéfice opérationnel des semi-conducteurs.

Le versement final exact reste incertain. L'implication macroéconomique, elle, ne l'est pas.

Si même une fraction de cette manne issue de la mémoire IA est distribuée à quelque 160 000 salariés de Samsung Electronics et SK hynix, l'effet sera très concentré mais extrêmement visible. Il se manifestera par :

- une demande accrue de logements premium autour de Séoul, Suwon, Yongin, Hwaseong, Icheon et Bundang ;
- des achats de voitures importées et de produits de luxe ;
- des dépenses en éducation privée et en voyages à l'étranger ;
- des flux vers la gestion de patrimoine, les dépôts bancaires et les investissements en actions domestiques ;
- des retombées de consommation autour des régions abritant les clusters de semi-conducteurs.

Il ne s'agit pas d'une inflation salariale généralisée à l'ensemble de la Corée. C'est un choc de revenu à haute intensité concentré sur une catégorie précise de main-d'œuvre industrielle qualifiée. Cette distinction est importante. Elle peut creuser les inégalités, mais elle crée également une impulsion réelle de consommation premium que les acteurs coréens du commerce de détail, de la banque, du courtage, de l'assurance et de l'immobilier ressentiront.
...
1. la détention directe par les investisseurs particuliers ;
2. les fonds actions domestiques ;
3. le KOSPI 200 et les ETF Corée ;
4. les comptes de retraite ;
5. le Fonds national de pension.
...
## 6. Quatrième canal de transmission : l'investissement et le multiplicateur fournisseurs
...
Mais une large part domestique reste bien en Corée. Cette absorption intérieure s'opère dans :

- la construction et l'aménagement de salles blanches ;
- les infrastructures électriques ;
- les systèmes d'eau et d'assainissement ;
- les gaz et produits chimiques de spécialité ;
- les substrats, circuits imprimés et emballages ;
- les équipements de test, d'inspection et d'automatisation ;
- la logistique, le logement et les services locaux autour des zones de fabrication.

C'est pourquoi le cycle de la mémoire IA se propage au-delà de Samsung et SK hynix. Il devient un cycle de demande pour les équipementiers coréens, les fabricants de substrats, les fournisseurs de matériaux avancés, les acteurs des réseaux électriques et les infrastructures régionales.

Pour les allocateurs étrangers, cela signifie que la thèse coréenne ne doit pas s'arrêter à deux valeurs. Les bénéficiaires de second rang peuvent offrir des points d'entrée de valorisation plus attractifs lorsque les méga-capitalisations sont déjà surchargées.

---

## 7. Cinquième canal de transmission : la prime de risque du marché actions coréen

La Corée a longtemps été pénalisée par une « décote coréenne ». La gouvernance, les retours aux actionnaires, le risque géopolitique, la cyclicité et la faiblesse de la demande intérieure ont contribué à des multiples de valorisation bas.

Le cycle de la mémoire IA de Samsung et SK hynix n'efface pas ces problèmes. Il modifie le point de départ du marché.
...
Si Samsung et SK hynix sont de simples valeurs du cycle mémoire, la Corée mérite un multiple cyclique. Si elles sont des fournisseurs incontournables de l'infrastructure IA mondiale, et si leurs bénéfices créent des canaux visibles de fiscalité, de salaires, de retraites et d'investissement domestique, alors la Corée mérite une décote moindre qu'auparavant.

C'est là le vrai débat de réévaluation.

Il ne s'agit pas seulement de savoir si Samsung devrait se rapprocher des valorisations de TSMC, ou si SK hynix devrait converger vers celles de Micron. Il s'agit de savoir si le KOSPI lui-même devrait être coté comme un marché dont les plus grandes entreprises sont désormais intégrées dans la chaîne d'investissement mondiale de l'IA.

---

## 8. Une cartographie simple de la transmission économique

| Canal | Ce qui change | Pourquoi c'est important pour les investisseurs étrangers |
|---|---|---|
| Bénéfices des entreprises | Samsung + SK hynix ont généré KRW 94,8T de bénéfice opérationnel au 1T26 | Confirme la puissance bénéficiaire de la mémoire IA coréenne |
| Capacité fiscale nationale | Un vivier de bénéfices plus large accroît les marges de manœuvre fiscales | Soutient la flexibilité budgétaire et la perception du risque souverain |
| Revenu des ménages | L'intéressement et les primes peuvent créer des chocs de revenu à haute intensité | Soutient la consommation premium, les banques, les courtiers et les services locaux |
| Patrimoine retraite | La réévaluation des méga-caps améliore les actifs indexés et de retraite | Crée des effets sur les bilans des ménages |
| Investissement | Samsung et SK hynix déploient d'importants budgets d'investissement | Dynamise les fournisseurs en substrats, énergie, équipements, matériaux et construction |
| Statut sur le marché actions | Samsung a franchi les 1 000 Mds$ de capitalisation ; SK hynix est devenue une méga-cap mondiale | Repositionne la Corée comme marché d'infrastructure IA, et non plus seulement comme beta d'exportation |

---

## 9. Le risque de concentration est réel

Cet article n'est pas un chant de victoire.

Le même mécanisme qui élève le poids économique de la Corée peut se retourner violemment si le cycle de la mémoire IA se retourne. La Corée l'a déjà vécu. Les recettes de l'impôt sur les sociétés ont chuté à KRW 62,5 billions en 2024 après un repli des bénéfices des entreprises, en forte baisse par rapport aux années précédentes. Les récessions mémoire peuvent provoquer des falaises fiscales.
...
## Note finale : la Corée change de catégorie de poids

Pour les investisseurs étrangers, la bonne question n'est plus seulement :

> « Dois-je acheter Samsung Electronics ou SK hynix ? »

La meilleure question est :

> « Que se passe-t-il pour la Corée lorsque Samsung et SK hynix deviennent des moteurs de trésorerie à l'échelle souveraine ? »

La réponse est désormais visible. La capacité fiscale progresse. Le revenu des travailleurs augmente dans des régions et des catégories de main-d'œuvre spécifiques. Les actifs de retraite et le patrimoine des ménages progressent avec les géants du KOSPI. L'investissement irrigue les chaînes d'approvisionnement en construction, énergie, équipements, matériaux et substrats. Le marché actions coréen devient de plus en plus difficile à ignorer en tant que marché à faibles multiples et exportations cycliques.

Cela ne supprime pas la décote coréenne. Cela donne au marché un nouvel argument pour la réduire.

Samsung Electronics et SK hynix ne sont plus simplement de grandes entreprises coréennes. Dans le supercycle de la mémoire IA, elles redimensionnent l'équation économique coréenne.

C'est pourquoi l'économie coréenne est en cours de réévaluation.
