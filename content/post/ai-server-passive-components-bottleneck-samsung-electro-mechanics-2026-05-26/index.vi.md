...
- Rack NVIDIA DGX GB200 tiêu thụ khoảng **120kW**; Lenovo GB300 NVL72 được mô tả ở mức **135kW TDP** và tối đa **155kW peak** mỗi rack. ([NVIDIA][1], [Lenovo][2])
...
- Samsung Electro-Mechanics đáng chú ý vì kết hợp **MLCC + FC-BGA + tụ silicon**.
...
TDK mô tả chuỗi nguồn trong data center là **UPS → PSU → IBC → VRM → điện áp CPU/GPU**, mỗi tầng đều cần hiệu suất, ripple thấp, chịu nhiệt và độ tin cậy dài hạn. ([TDK][3])
...
Samsung Electro-Mechanics công bố hợp đồng tụ silicon khoảng **1.5 nghìn tỷ won** cho giai đoạn **2027-2028**. Công ty cho biết linh kiện này cải thiện độ ổn định nguồn bên trong package bán dẫn hiệu năng cao cho máy chủ AI. ([Samsung Electro-Mechanics][8])
