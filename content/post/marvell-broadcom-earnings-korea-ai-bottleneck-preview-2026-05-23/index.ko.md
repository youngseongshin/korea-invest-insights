...
브로드컴은 이 흐름의 가장 큰 숫자다. Q1 FY2026 매출은 **193.11억 달러**, AI 매출은 **84억 달러**, Q2 전체 매출 가이던스는 **220억 달러**, Q2 AI 반도체 매출 가이던스는 **107억 달러**다. 산식상 Q2 AI 반도체 매출은 전체 매출 가이던스의 <strong>48.6%</strong>다. 브로드컴은 더 이상 “반도체 + VMware”가 아니라 **AI 맞춤형 칩과 AI 네트워크에 VMware 현금흐름이 붙은 회사**로 봐야 한다. ([Broadcom][1])

마벨은 숫자는 작지만 신호는 더 날카롭다. Q4 FY2026 매출은 **22.19억 달러**, Q1 FY2027 가이던스는 <strong>24.0억 달러 ±5%</strong>다. Q4 데이터센터 매출은 **16.51억 달러**, 매출 비중 <strong>74%</strong>다. 마벨이 Q2 가이던스와 데이터센터 매출에서 재가속을 보여주면, 시장은 “AI 병목이 연산칩에서 연결·광·메모리 이동으로 내려오고 있다”는 쪽으로 다시 가격을 매길 수 있다. ([Marvell][2])
...
마벨의 Q4 데이터센터 매출은 **16.51억 달러**, 전체의 <strong>74%</strong>다. 이제 마벨은 더 이상 범용 반도체 사이클주가 아니다. 데이터센터 AI 인프라 반도체 회사로 재분류된 상태다. ([Marvell][2])
