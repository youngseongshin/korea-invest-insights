...
> 📚 Series Pearl Abyss
> Đã đề cập trước đó: phản ứng sau khi ra mắt, tóm tắt kết quả 1Q26, cấu trúc ghi nhận doanh thu Crimson Desert

*Pearl Abyss ghi nhận kỷ lục 1Q26: doanh thu 328,5 tỷ KRW, lợi nhuận hoạt động 212,1 tỷ KRW. Thế nhưng cổ phiếu vẫn yếu. Trong cùng cuộc họp kết quả, công ty cho biết đang "khám phá các giai đoạn mở rộng tiếp theo bao gồm cả DLC" cho Crimson Desert. Báo chí nước ngoài đọc đó là "DLC đã xác nhận," thị trường rúng động rồi lại trôi xuống thấp hơn. Ý nghĩa của câu DLC đó đang bị hiểu sai rộng rãi. Tiêu đề không phải là "60 tỷ KRW doanh thu DLC." Tiêu đề là bình luận này xóa bỏ "chiết khấu vách đá 2027" mà thị trường đang áp dụng cho Pearl Abyss. Điều đó đẩy định bội số từ PER một chữ số về phía mức bình quân nhà phát hành game toàn cầu (15–25x) — và sự tái phân loại đó quan trọng hơn nhiều so với con số doanh thu thuần túy.*
...
## 1. Thị trường nhìn nhận Pearl Abyss như thế nào hiện nay

### 1.1 Tại sao một quý kỷ lục vẫn dẫn đến bán tháo
...
### 1.2 Điều thị trường lo ngại — "vách đá game bán lẻ"

```
Mô hình doanh thu game bán lẻ điển hình:
...
### 1.3 PER một chữ số thực sự ngụ ý điều gì

```
PER hiện tại của Pearl Abyss:
...
## 2. Bình luận DLC thực sự nói gì — không phải xác nhận

### 2.1 Ban quản lý thực sự nói gì

```
Từ thư kết quả kinh doanh 1Q26:
...
### 2.2 Ngay cả "đang khám phá" cũng có trọng lượng

```
Ý nghĩa khi một công ty đưa "đang khám phá DLC" vào văn bản IR:
...
### 2.3 Tại sao thị trường không phản ứng mạnh hơn

```
Lý do 1: Áp lực vĩ mô toàn cầu
...
## 3. DLC thực sự tạo ra điều gì — doanh thu trực tiếp so với thay đổi định bội số

### 3.1 Tác động doanh thu trực tiếp (nhỏ hơn)
...
Bảng kịch bản doanh thu tăng thêm:
...
```
Kịch bản cơ sở (doanh thu DLC 55–75 tỷ KRW, lợi nhuận HĐ 35–50 tỷ KRW):
...
### 3.3 Tác động thay đổi định bội số (lớn hơn)

```
Đây mới là câu chuyện thực:
...
### 3.4 Tại sao hiểu sự khác biệt này quan trọng
...
## 4. Giá trị hợp lý theo kịch bản

### 4.1 Kịch bản theo PER áp dụng

```
Kịch bản A (xấu — vẫn là game bán lẻ):
...
### 4.2 Vị thế giá hiện tại — bất đối xứng

```
Giá hiện tại gần với kịch bản A.
...
## 5. Sáu tháng tới — những gì cần theo dõi

### 5.1 Công ty phải cho thấy gì

```
Tín hiệu cần thiết để chuyển A → B:
...
### 5.2 Bản thân game phải cho thấy gì
...
## 6. Quyết định giao dịch — người đang nắm giữ vs. người mua mới

### 6.1 Nếu bạn đang nắm giữ
...
### 6.3 Luận điểm cốt lõi — "đây là cửa sổ 'công ty phải tung lá bài'"

```
Bản chất của Pearl Abyss lúc này:
...
## 7. Mối liên hệ với các bài viết khác
...
*Bài viết này chỉ là nghiên cứu và bình luận, không phải lời khuyên đầu tư. Số liệu 1Q26 và hướng dẫn FY2026 của Pearl Abyss là theo thư kết quả kinh doanh chính thức của công ty. Cách xử lý ghi nhận doanh thu Crimson Desert (PC trừ thuế; console trừ phí nền tảng) theo công bố của công ty. Câu "exploring various ways including DLC" là trích dẫn nguyên văn từ thư kết quả 1Q; từ "confirmed" không được dùng. Ước tính \~5,8 triệu bản tích lũy được suy luận từ dữ liệu đánh giá Steam; cột mốc chính thức là 5 triệu tính đến ngày 15/4. Các kịch bản doanh thu DLC (cơ sở cài đặt, tỷ lệ gắn kết, giá) là ước tính của tác giả và chưa được xác nhận. PER một chữ số được áp dụng là ước tính dựa trên giá ngày 15/5 và EPS đồng thuận 2026E. Biên kịch bản PER 6–18x là ước tính của tác giả và không được đảm bảo. Các biến vĩ mô toàn cầu (lãi suất Mỹ, dầu, tỷ giá, VIX) có thể độc lập tác động đến cổ phiếu. Phân tích có thể sai. Dữ liệu cập nhật đến: 15/5/2026 KST.*
