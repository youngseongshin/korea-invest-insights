---
title: "Pearl Abyss — Consolidando los ₩60.000 como nuevo nivel de soporte: un traspaso saludable del retail a las instituciones el 27 de abril"
...
tags: ["pearl-abyss", "263750", "crimson-desert", "ventas-en-corto", "lectura-de-tape", "flujo-institucional", "traspaso-retail", "nivel-de-soporte", "series"]
...
| Máximo | ₩61.700 |
| Mínimo | ₩58.700 |
| Volumen | 1.052.139 acc. |
| Facturación | ₩63,64B |

Incluyendo NXT / preapertura:

| Métrica | Valor |
|---|---:|
| Máximo de sesión | ₩62.600 |
| Mínimo de sesión | ₩58.100 |
| Volumen acumulado | 1.398.606 acc. |
| Facturación acumulada | ₩84,21B |

Narrativa intradía:

```text
Preapertura imprime hasta ₩62.600 (carga frontal)
→ La sesión regular abre y cae hasta ₩58.700
→ Recuperación hasta ₩61.700
→ Se mantiene por encima de ₩60.000 durante la tarde
→ Cierra en ₩60.200
```
...
VWAP de sesión regular sobre el conjunto del flujo:
...
## 3. Comparativa reciente de volumen corto
...
```text
Ventas estilo retail de Kiwoom
+ Ventas netas estimadas de casas extranjeras
+ 75.930 acciones de cortos oficiales
→ Absorbidas por compras institucionales lideradas por Shinhan / Korea Investment
...
| Factor | Rally por compra extranjera | Estructura de hoy |
|---|---|---|
| Base de compradores | Fuente única (sensible a FX + macro) | Institucional doméstico (más estable) |
| Reversibilidad | Se revierte con FX / risk-off | Requiere que los fundamentales se deterioren |
| Calidad del flotante | Dinero caliente | Tenedores re-anclados |
...
## 7. El carácter exacto del día — en una línea
...
- Compra institucional neta vía Shinhan / Korea Investment
- Punto de presión construido en el VWAP corto de ₩60.390
- Confirmación de que el sizing de alta convicción sigue siendo válido
...
## 9. Mañana — Manual de escenarios

### Escenario A — mejor caso

Condiciones:
- Abre por encima de ₩60.400
- No cae y se mantiene por debajo de ₩60.000
- Recupera ₩61.700
- Facturación ≥ ₩60–80B
...
### Escenario B — digestión ordenada

Condiciones:
- Rango lateral ₩59.500 – ₩61.000
- Facturación ₩40–70B
- Aunque ₩60.000 se rompa, recuperación rápida
...
### Escenario C — precaución

Condiciones:
- Se mantiene de forma significativa por debajo de ₩60.000
- Re-test del mínimo intradía de ₩58.700
- El volumen corto se re-expande por encima de 150K acciones
- Extranjeros e institucionales ambos con ventas netas
...
## 10. Manual de posición larga por nivel de precio
...
## 11. Puntos de control del lado corto
...
+ Cierre por encima de ₩60.000
+ 7,2% de participación corta absorbida
+ Oferta retail / con margen absorbida
+ Compra institucional neta vía Shinhan / Korea Investment
...
- La estructura de flujo de hoy es un traspaso retail → institucional, no un rally liderado por extranjeros.
- El coste corto en ₩60.390 frente al cierre de ₩60.200 significa que un pequeño movimiento al alza mañana deja a los cortos en pérdidas.
- Los ₩60.000 han pasado de ser resistencia a soporte de primera línea.
- La compra institucional doméstica de múltiples fuentes es estructuralmente más estable que la compra extranjera de fuente única.

### [Especulación]

- Una ruptura limpia por encima de ₩61.700 / ₩62.600 con facturación creciente probablemente desencadenaría un cierre de cortos.
- Si Shinhan / Korea Investment mantienen la postura de compra neta durante 2–3 sesiones más, los ₩60.000 se consolidan como suelo de soporte duradero.

### [Sin confirmar]

- Confirmación en tiempo real de las cifras finales de inversores por tipo (sujeto a revisión post-cierre).
- Identificación de la casa extranjera detrás de las ventas netas estimadas.
- Saldo corto neto KRX actualizado del 23 al 27 de abril (retraso en la divulgación).
