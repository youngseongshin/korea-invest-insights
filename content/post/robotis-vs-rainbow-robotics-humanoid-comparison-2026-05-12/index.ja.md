...
>
> 🔗 **関連**: [ヒューマノイド／ロボティクス投資ハブ](/page/korea-humanoid-robotics-hub/) · [Hyundai Mobis 詳細分析](/post/kr-deep-dive-hyundai-mobis-2026-04-28/) · [Samsung Electro-Mechanics AIインフラ再評価](/post/samsung-electro-mechanics-ai-infrastructure-rerating-2026-04-21/)
...
* **Robotis ＝ ロボットの「指・関節」。** Dynamixelアクチュエーターが中核製品。2025年売上高₩38.9bn、**営業利益黒字転換₩3.4bn**、時価総額 約₩5.1tn。2026E PSR 79×、2027E PSR 50× — **バリュエーション圧縮の経路は見えている。**
* **Rainbow Robotics ＝ Samsung Electronicsをアンカー株主に持つヒューマノイドプラットフォーム。** 協働ロボット（RBシリーズ）、双腕モバイルロボット（RB-Y1）。2025年売上高₩34.1bn、**営業損失 -₩2.5bn**、時価総額 約₩16.2tn。2025年PSR 476× — **Robotisのバリュエーションに並ぶには、2027年に売上高 約₩330bn・純利益 約₩63bnが必要。**
* **売上高が小さく赤字なのにRainbowの時価総額がRobotisの3倍である理由。** Samsung Electronicsがアンカー株主として35%を保有。市場は「Samsungのロボティクス戦略 ＝ Rainbowの将来収益」を織り込んでいる。
* **比較の結論。** Robotisの方が検証しやすい。業績は既に出始め、2027年までの成長パスは数字で追える。Rainbowのオプション価値は大きいが、現在の時価総額を正当化するには2年で売上高10倍が必要であり、その数字はまだ見えない。**どちらも割高である。**
...
Robotisの中核製品は**Dynamixelアクチュエーター** — モーター・減速機・センサー・電子回路を一体化した「関節駆動モジュール」だ。[Part 1](/post/korea-robotics-value-chain-complete-map-2026-05-11/)でも触れた通り、ロボットの関節を動かす基幹部品である。
...
**「ロボットハンド」がなぜ重要か**：Part 1で「なぜヒューマノイドは難しいか」のProblem #2として「指」を挙げた。工場の人手を代替するには、歩行よりも**把持・回転・挿入・押下・組立という手の動作**が本質的に重要だ。Robotisはそのボトルネックに直接位置している。

### 1.2 Rainbow Robotics — ロボットの「全身」

Rainbow Roboticsは**ロボット全体を設計・製造するロボットプラットフォーム企業**だ。KAISTのHUBO研究グループから独立し、韓国で最も知名度の高いヒューマノイドロボットブランドである。
...
|---|---:|---:|
| 株価 | ₩345,000 | ₩837,000 |
| 時価総額 | **約₩5.1tn** | **約₩16.2tn** |
| 2025年売上高 | **₩38.9bn** | ₩34.1bn |
| 2025年営業利益 | **+₩3.4bn（黒字）** | -₩2.5bn（赤字） |
| 2025年OPM | **約8.7%** | 約-7.3% |
| 2025年PSR | 約130× | **約476×** |
| **2026E売上高** | **₩64.0bn** | 未確定（推定₩130〜210bn必要） |
| **2026E営業利益** | **₩9.0bn** | ₩32.0bn（コンセンサス） |
| **2026E PSR** | **79×** | 78〜130×（売上高前提による） |
| **2026E PER** | **496×** | 約518× |
| **2027E売上高** | **₩101.0bn** | 未確定（推定₩330bn必要） |
| **2027E PSR** | **50×** | 未確定 |
| **2027E PER** | **264×** | 未確定 |
| バリューチェーン上の位置 | 部品（アクチュエーター） | 完成品（プラットフォーム） |
| コアプレミアム | 純粋アクチュエーター | **Samsung Electronicsアンカー株主** |
...
**Rainbowの時価総額はRobotisの3.2倍だが、売上高は小さく赤字だ。** Robotis売上高₩38.9bn > Rainbow売上高₩34.1bn。Robotisは黒字、Rainbowは赤字。それでも時価総額はRobotis ₩5.1tn < Rainbow ₩16.2tn。

この乖離を生んでいるのは一語：**Samsung**。Samsung Electronicsが35%をアンカー株主として保有し、Samsungの半導体・ディスプレイ・家電・物流にRainbowのロボットを展開するという戦略が、既に株価に織り込まれている。

シンプルに整理すると：

* Robotisの株価 = **現在の業績 ＋ 将来のアクチュエーター成長期待**
* Rainbowの株価 = **Samsungがロボティクスで成功するという期待**
...
黒字のロボット企業とは**「ビジネスモデルが実際に稼げることを意味する」**。韓国ロボット銘柄の多くはR&Dで資金を燃やし続けているが、RobotisはDynamixelアクチュエーターを販売し、リアルなキャッシュフローを生んでいる。
...
|---|---:|---:|---:|
| 売上高 | ₩38.9bn | **₩64.0bn（+65%）** | **₩101.0bn（+58%）** |
| 営業利益 | ₩3.3bn | **₩9.0bn** | **₩20.0bn** |
| OPM | 8.5% | **14.1%** | **19.8%** |
| EPS | 約₩380 | **₩696** | **₩1,306** |

証券会社間のばらつきは大きい。Samsung証券の2026年売上高₩51bn（保守的）、Daol Investment & Securities₩80bn（積極的）。コンセンサス中央値₩64bnはその間に位置する。決め手となる変数は**大型アクチュエーターQDD（Dynamixel Q）の量産化速度**だ。
...
ハナ証券によれば、2026年のアクチュエーター受注は**100万台超**と見積もられる。2025年の実際の生産台数は**22万台**だった。需要はある、供給能力が足りない。
...
100万台超の受注に対して生産できるのは50万台 = **需要は十分、供給制約**。悪くない分析構造だ — 作れれば売れる。

注意点：「100万台受注」が**確定発注（PO）**なのか**問い合わせ・引き合いレベル**なのかは開示されていない。その区別は重要だ。
...
Samsungがロボティクスに進出する理由はPart 1で触れた — 「Physical AI」だ。Samsungは**製造（半導体・ディスプレイ）の自動化を皮切りに、家庭・小売へと展開**する構想を持つ。
...
3Q25時点で、Samsung ElectronicsのRainbow Roboticsへの発注累計は約**₩6.9bn**。年換算すると約**₩10bn**のSamsung関連売上高だ。

時価総額₩16.2tnの企業が、筆頭株主顧客から得ているのが約₩10bn = まだ**テスト・パイロット段階**だ。Samsungが実際の工場に数百〜数千台規模で大量発注する段階には至っていない。
...
|---|---|---|---|
| **業績** | 黒字、OPM 8.7% | 赤字 | **Robotis** |
| 売上高成長率 | +30% | **+76%** | Rainbow |
| **2025年PSR** | 130× | 476× | **Robotis** |
| **2026E PSR** | **79×** | 78〜130×（推定） | **Robotis（数字確定）** |
| **2027E PSR** | **50×** | 未確定（₩330bn売上高が必要） | **Robotis** |
| **2026E PER** | **496×** | 約518× | 大差なし；Robotisの方が視認性高い |
| **2027E PER** | **264×** | 未確定（純利益 約₩63bn必要） | **Robotis** |
| 主要顧客 | LG Electronics（第2株主） | **Samsung Electronics（筆頭株主）** | Rainbow |
| **検証可能性** | 高い（受注・生産・マージンが追跡可能） | 低い（Samsungの社内戦略依存） | **Robotis** |
| 業界レバレッジ | 部品 → 多くのロボットに入れる | 完成品 → Rainbow自身の成功依存 | Robotis |
| オプションの大きさ | 中（アクチュエーター市場） | **大（Samsungのロボティクス全体戦略）** | Rainbow |
...
**自動車業界の例え**：Robotisは複数OEMにエンジンとトランスミッションを供給するBosch型サプライヤー — 業界と共に成長する。RainbowはSamsungが出資したEVスタートアップ — 当たれば巨大だが、失敗すれば資本を失う。

### 5.3 相対評価 — Robotisの方が検証しやすい

三つの理由：

**一：業績が既に出ている。** Robotisは黒字転換済み。セルサイド推計によれば2026年のOPMは約15%に達する可能性がある。Rainbowは赤字継続中だ。

**二：検証が可能だ。** Robotisは「100万台受注のうち何台を生産したか、ASPはいくらか、マージンは」を四半期ごとに確認できる。Rainbowの「Samsungが実際に何台発注したか」は外部から把握しにくい。

**三：バリュエーション圧縮の経路が見える分、割高感が相対的に低い。** Robotisの2026E PSR 79× → 2027E 50×は**バリュエーション圧縮の道筋**を示している。Rainbowの2026E PSRは売上高前提がなければ計算すらできず、2027E公開コンセンサスも存在しない。視認性が異なる。

**注意：「Robotisの方が検証しやすい」≠「Robotisが割安」。** どちらも割高だ。Robotisの2027E PSR 50×・PER 264×でも、売上高₩101bnかつOPM 20%が実現してはじめて理屈が通る。
...
**読み方**：2026年PER 496×は極端だが、2027年PER 264×・PSR 50×への移行には**バリュエーション圧縮の経路**が見える。売上高₩64.0bn → ₩101.0bn、OPM 14% → 20%は「高成長部品株」としての論拠を支える。

確認すべき変数：2026年売上高₩60bn超・OPM 14%超の維持。

セルサイド目標株価の平均は約₩317,000、最高値（Daol Investment & Securities）は₩435,000。**現在の₩345,000は既に平均目標株価を上回っている。**

### 6.2 Rainbow Robotics — コンセンサスが薄い。逆算アプローチで考える

Rainbowの問題は**信頼できるコンセンサスが少ない**ことだ。確認できるのは2026E営業利益₩32.0bn（FnGuide）のみ。2026年売上高と2027年の数字は公開コンセンサスが存在しない。

そこで、現在の時価総額を正当化するために**必要な数字を逆算**する。

**2026年逆算 — 営業利益₩32.0bnを生むには売上高がいくら必要か：**
...
**1年で売上高を4〜6倍にする必要がある（₩34.1bn比）。** 大規模なSamsung関連売上高なしには事実上不可能だ。

現在時価総額から計算した2026E PERは約**518×**（₩16.6tn / 推定純利益）。Robotisの2026E PER（496×）と近似するが、Robotisの場合は売上高・営業利益の推計が確定的である一方、Rainbowの売上高視認性は低い。

### 6.3 2027年アラインメントの計算

Robotisの2027年バリュエーションはPSR 50×・PER 264×。**Rainbowが同水準に並ぶには2027年に何が必要か：**

| 基準 | Rainbowに必要な数字 |
|---|---:|
| Robotis 2027E PSR（50×） | 売上高 約**₩330bn** |
| Robotis 2027E PER（264×） | 純利益 約**₩63bn** |

クロスチェック：₩16.6tn / 50 = ₩332bn売上高 ✓；₩16.6tn / 264 = ₩62.9bn純利益 ✓

**Rainbowが現在の時価総額をRobotisのバリュエーションに合わせるには、2年間で売上高₩330bn・純利益₩63bnが必要だ。** ₩34.1bnから2年で約10倍 — 年率換算で約+211%。
...
|---|---:|---:|---:|---:|---:|
| ベア | ₩2.0tn | ₩3.0tn | ₩5.0tn | 約₩255,000 | **-70%** |
| ベース | ₩4.8tn | ₩6.0tn | ₩10.8tn | 約₩550,000 | **-34%** |
| ブル | ₩10.0tn | ₩8.0tn | ₩18.0tn | 約₩920,000 | +10% |

セルサイド目標株価の平均：Robotis 約₩317,000、Rainbow 約₩580,000。**どちらも現在株価は平均目標株価を上回っている。**
...
**RainbowはSamsungオプション実現のベストケースでも+10%しか余地がなく、ベースへの回帰で-34%という構造に置かれている。** 数字の上では新規参入には不利な非対称性だ。
...
Robotisは**「業績が出始めたコンポーネント・サプライヤー」**だ。営業利益は黒字転換済み、アクチュエーター受注は伸び、QDDの量産が売上高を段階的に引き上げる態勢にある。割高だが、数字で検証できる。

Rainbow Roboticsは**「巨大なSamsungオプションを価格に折り込んだ企業」**だ。Samsungのロボティクスの成功がRainbowを成功させる。だが現在の株価には既にその成功の大部分が織り込まれている。ブルケースでも+10%しかなく、ベースへの回帰は-34%を意味する。

二社を比べれば、**Robotisの方が検証しやすい**。ただしRobotisも₩345,000という現在株価はベースケースの試算値（₩310,000）を上回っている。最も規律のある分析アプローチは、**1Q決算での売上高成長とOPM、そしてQDD量産の進捗**を追うことだ。
...
**Q：RobotisとRainbow Robotics、どちらが良い企業ですか？**
...
**Q：なぜRainbowはRobotisの3倍の時価総額なのですか？**
