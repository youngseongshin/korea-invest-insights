...
## 1. Calendrier des résultats de la semaine prochaine — 10 valeurs en un coup d'œil

| Date | Société | Perf. 20 j. | RO consensuel FnGuide | Point d'attention |
|---|---|---:|---:|---|
...
| 15/05 Ven | Lotte Chemical | +9,1 % | -₩20,3 Mds | Test de reprise de la chimie ; risque baissier |
| 15/05 Ven | DB Insurance | -1,9 % | ₩452,4 Mds | Attractivité relative vs. Samsung F&M |
| 15/05 Ven | CJ Corporation | +13,5 % | ₩567,2 Mds | Captation de valeur Olive Young |

(Consensus FnGuide. Performances 20 jours au 8 mai.)

---

## 2. Classement des surprises — qui est le plus susceptible de déjouer le consensus
...
```
Observable + non intégré (forte probabilité de surprise) :
...
## 3. Pearl Abyss — le principal candidat à la surprise

### 3.1 Pourquoi le consensus est si bas

Le RO consensuel de Pearl Abyss pour le 1T26 est de ₩143,5 Mds. Certains analystes sell-side se positionnent bien au-dessus :

| Broker | Estimation RO 1T26 | Vs. consensus |
|---|---:|---:|
...
Selon les communications officielles de Pearl Abyss :
...
| Scénario | RO | Réaction du titre |
|---|---:|---|
| A. Dépassement | ≥₩220 Mds | Rebond court terme de +10-15 %. Un mouvement durable exige une confirmation de la persistance au T2 |
| B. En ligne | ₩140-180 Mds | Réaction limitée. Les indications sur les ventes T2 deviennent le déterminant directionnel |
| C. Déception | <₩140 Mds | Des inquiétudes sur les taux de remboursement / la structure des commissions émergent. Poursuite de la baisse. Probabilité < 10 % |

---

## 4. SK Innovation — chiffres élevés, qualité faible

### 4.1 La structure de l'écart
...
## 5. Mirae Asset Securities — résultats solides, mais pas vraiment surprenants

### 5.1 Pourquoi les résultats doivent être solides

Le volume journalier moyen du KOSPI au T1 s'est établi à ₩45,3 billions — soit +147 % en GA par rapport à ₩18,4 billions. Le courtage est très sensible au volume : commissions de courtage, intérêts sur les prêts sur marge et P&L du trading pour compte propre évoluent tous en proportion.

Le RO consensuel de ₩1 357 Mds est déjà en hausse de +39 % par rapport au consensus début mars de ₩978,2 Mds.
...
## 6. Lotte Chemical — risque de surprise négative

Le consensus table sur une perte opérationnelle de -₩20,3 Mds. Certains rapports individuels portent cette perte à -₩121,8 Mds — soit 6 fois plus large.

Le facteur déterminant est le coût du naphta. Les tensions sur le détroit d'Ormuz liées à l'Iran ont structurellement renchéri le naphta. Le consensus n'a peut-être pas pleinement intégré cette pression sur les coûts.

Le rallye de +9,1 % sur 20 jours signale des achats spéculatifs sur le thème du « creux de la chimie ». Si la publication déçoit, ces positions se dénoueront.
...
## 7. Assureurs, distributeurs, holdings — les résultats ne sont pas la variable principale
...
RO consensuel : ₩207,5 Mds. Une prévision individuelle place ce chiffre à ₩212,4 Mds. Écart : +2,4 %. Résultat solide, pas une surprise. 92 % du bénéfice provient des grands magasins ; le titre est en hausse de +28,8 % sur 20 jours. La durabilité des grands magasins et la compression des pertes dans le discount / l'e-commerce comptent davantage que le chiffre de RO en titre.
...
## 8. Mise en perspective — résultats américains de la même semaine

| Date | Société | Pourquoi c'est important |
|---|---|---|
...
## 9. Priorités pratiques — ce qu'il faut suivre la semaine prochaine
...
Pearl Abyss est le principal candidat à une surprise de résultats pour le 1T26 parmi les 10 publications coréennes de la semaine prochaine. RO consensuel de ₩143,5 Mds contre un résultat probable supérieur à ₩250 Mds. Crimson Desert s'est vendu à 4 millions d'unités en 12 jours après son lancement, et l'essentiel des revenus imputables au T1 tombe bien sur cette période.
