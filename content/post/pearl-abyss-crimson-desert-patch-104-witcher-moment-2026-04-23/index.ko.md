...
수정 EPS ₩5,500\~5,750에 **P/E 15×**를 적용하면 fair value 추정 범위는 **약 ₩82,500\~86,250**이다. 당시 주가 ₩53,100과 비교하면 리레이팅 여지가 남아 있다는 해석이 가능하다. 핵심은 단일 패치의 흥행이 아니라, 시장이 이 회사를 단발 게임 출시주로 볼지, 반복 운영 역량을 가진 IP 플랫폼으로 볼지다.
