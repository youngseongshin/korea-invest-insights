...
이 논리는 사실 마이크론만의 것이 아닙니다. SK하이닉스도 HBM 고객 요청이 향후 3년 생산능력을 크게 초과한다고 밝혔습니다. ([Reuters][6]) 따라서 이 리레이팅은 메모리 3사 공통 요인입니다. 차이는 미국 시장이 이 논리를 마이크론에 더 쉽게, 더 빠르게 가격화한다는 점입니다.
