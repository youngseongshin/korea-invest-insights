...
title: "Pearl Abyss (263750.KQ) Rapport Quotidien — Le Support à KRW 55 000 Tient, dans l'Attente de l'Annonce des 5M"
description: "Rapport quotidien Pearl Abyss du 9/4. Range KRW 55 000 (support) / 56 600 (résistance). La flambée des ventes à découvert est liée à la couverture. Les étrangers ont acheté +2,53M d'actions sur trois semaines, mais l'élan s'essouffle. L'annonce des 5M d'exemplaires est imminente."
...
|--------|------|
| Support | KRW 55 000 |
| Résistance | KRW 56 600 |
| Confirmation de retournement haussier | Maintien durable au-dessus de KRW 57 000 |

---

## 2. Analyse des Ventes à Découvert

### 2.1 Ventes à Découvert Transactionnelles

Le volume des ventes à découvert a atteint 232 474 actions (+134,9 % sur un jour). Toutefois, le prix d'exécution moyen (KRW 55 968) était inférieur au cours de clôture (KRW 56 500), ce qui signifie que les nouvelles positions courtes ont enregistré une perte en séance. La part des exemptions à la règle de hausse de 25,2 % indique une proportion significative d'opérations de couverture et de tenue de marché, mêlées à des ventes directionnelles.
...
### 3.1 Flux des Principaux Courtiers

La zone haute (KRW 56 600–57 500) a été dominée par les ventes de Shinhan et des courtiers étrangers, tandis que le plancher (KRW 55 000) a été défendu par des achats à contre-tendance menés par Kiwoom (+87 003 actions). Les vendeurs n'ont pas pris le contrôle du marché aujourd'hui.

### 3.2 Tendance de la Détention Étrangère

Les investisseurs étrangers ont effectué des achats cumulatifs à grande échelle (+2,53 millions d'actions) sur trois semaines, constituant la base structurelle du niveau de prix actuel. Cependant, au 8/4, le flux journalier est repassé négatif à –85 926 actions, signalant un essoufflement de l'élan acheteur. Ce mouvement coïncide avec des ventes nettes institutionnelles cumulatives (–366 478 actions du 2/4 au 8/4), ce qui suggère une phase d'ajustement.

---

## 4. Crimson Desert — Suivi Produit

### 4.1 KPIs Clés

| Indicateur | Valeur | Remarques |
|------------|--------|-----------|
| Classement mondial des ventes | #1 maintenu | Steam Global |
| Taux d'avis positifs | 83,5 % | « Très Positif » maintenu |
| Creux de CCU | 75 650 | En baisse par rapport à 79 017 la veille |
| Taux de rétention moyen | 67,0 % | Résilience de la longue traîne intacte |
...
## 5. Calendrier des Catalyseurs et Événements

| Échéance | Événement | Implication |
|----------|-----------|-------------|
...
## 8. Pourquoi la Journée a été si Disputée
...
## 9. Conclusion & Checklist de Suivi
...
- Franchissement de KRW 56 600 et maintien durable (idéalement KRW 57 000)
- Reprise de l'augmentation de la détention étrangère
- Redressement des creux de CCU, taux de rétention moyen de retour à 70 %

### Confirmation de Réaccélération Baissière

- Rupture de KRW 55 000 avec volume
- Réaccumulation des positions courtes ouvertes
- Ventes institutionnelles nettes soutenues, continuité des ventes étrangères
- Baisse du nombre de nouveaux avis et du taux d'avis positifs

### Suivi Événementiel

- Calendrier de l'annonce officielle des 5M
- Publication de la date de résultats T1 et tonalité de la conférence téléphonique
- Communication de la direction sur la trajectoire au-delà des 6M
