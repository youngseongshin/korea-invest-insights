...
> 📚 **Series 1/3**: [KOSDAQ Structural Deep-Dive — series hub →](/series/kosdaq-structural-2026/)
...
1. **New buyers for pre-IPO, secondary, mezzanine, CB/BW** — a new counterparty class, not just new capital.
...
1. **BDC #1 issuance scale, premium/discount, trading volume, and portfolio composition.** The first BDC defines the category's credibility.
2. **Retail Participation Growth Fund subscription pace.** Real retail money, not talking points.
3. **Pension actual KOSDAQ weight changes.** Benchmark adoption ≠ execution.
4. **1–2 AI special-listing success cases with sustained aftermarket performance.** Without these, the pipeline doesn't open.
5. **Average multiple compression on the KOSDAQ index after the first delisting wave.** If the discount doesn't narrow, the policy package underdelivers.
