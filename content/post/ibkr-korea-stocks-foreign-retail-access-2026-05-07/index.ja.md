...
> **ニュース解説とプレイブック。** この記事は新設した[海外投資家向け韓国株ハブ](/page/korea-stocks-foreign-investors-hub/)と連動しています。同ハブでは、IBKR経由のアクセス方法・KOSPI・KOSDAQ・HBM・AIサブストレート・韓国金融株・Pearl Abyss・K-ビューティーに関するリサーチを海外読者向けに整理しています。
...
5. **私たちの対応は「発見アーキテクチャ」の構築だ。** Korea Invest Insightsは英語ファーストのハブ・直接回答型FAQページ・内部リンク・ソース付き入門コンテンツ・多言語展開を整備し、この新たな海外検索需要を取り込んでいく。
...
そのため私たちは[Samsung Electronics・SK Hynix・HBM・KOSPIハブ](/page/korea-semiconductor-hbm-kospi-hub/)を作成した。一つの答えを押しつけるためではなく、ファクターマップを説明するためだ：指数集中度・HBMシェア・AIメモリ需要・ファウンドリ回復・KOSPIの再評価。
...
これは抽象的な「韓国スモールキャップ」の話ではない。物理的なボトルネックの話だ。ラックスケールのAIシステムはより多くのチップを必要とし、そのチップはより高度なサブストレートと低損失材料を必要とする。それが[AI PCB・サブストレートハブ](/page/korea-ai-pcb-substrate-hub/)の背後にある論理だ。
...
[韓国金融ハブ](/page/korean-financials-hub/)は今後、Value-Upマップとしてだけでなく、海外アクセスマップとしても読まれるべきだ。
...
[Pearl Abyss / Crimson Desertハブ](/page/pearl-abyss-crimson-desert-hub/)が存在するのはまさにこのためだ：グローバルIPへの疑問を、韓国上場株のリサーチパスへと変換する。

### 3.5 K-ビューティーと医療美容

K-ビューティーも海外個人投資家に親しみやすいテーマだ。KOSPIやKOSDAQを知る前に、Olive Young・Rejuran・PDRN・スキンブースター・医療美容・韓国コスメを知っている海外読者は多い。

これは別種のファネルを生む。「Olive Youngは上場しているか？」から始まった読者が、PharmaResearch・Classys・Hugel・APRという韓国のビューティー・美容医療の上場株へと到達するかもしれない。[K-ビューティーハブ](/page/k-beauty-olive-young-pharmaresearch-hub/)はその発見パスを中心に設計されている。
...
Korea Invest Insightsはこれを単なるニュースとしてではなく、獲得チャネルとして扱うべきだ。

### 6.1 海外投資家向けエントランスを構築する

新設した[海外投資家向け韓国株ハブ](/page/korea-stocks-foreign-investors-hub/)がファネルの入口ページだ。その役割は、読者が私たちの内部カテゴリーを知る前の自然な疑問に答えることだ：

- 外国人はIBKRを通じて韓国株を買えるか？
- KOSPIとは何か？
- KOSDAQとは何か？
- 最初に知るべき韓国AI株はどれか？
- Pearl Abyssは上場しているか？
- Value-Upの恩恵を受ける韓国金融株はどれか？
- 上場している韓国K-ビューティー銘柄はどれか？

### 6.2 各ハブが検索クエリに直接答える設計にする

各ハブには投資論文だけでなく、直接回答型のFAQ表現が必要だ。目標はSEOと同時にAEO（Answer Engine Optimization）だ：ChatGPT・Perplexity・Google AIオーバービュー・Naver検索・通常の検索スニペットに対して、短く・出典が明確で・構造化された回答が必要だ。

内部アーキテクチャはこのようになるべきだ：

```
IBKR / 海外アクセスハブ
   -> Korea 日次マーケットハブ
   -> Samsung / SK Hynix / HBMハブ
   -> AI PCB・サブストレートハブ
   -> 韓国金融ハブ
   -> Pearl Abyssハブ
   -> K-ビューティーハブ
...
同じ記事を一つの汎用的な見出しで発信してはいけない。複数のエントリーアングルが必要だ：

| チャネル | アングル |
|---|---|
| Substack | 「韓国市場が海外個人投資家にとって検索可能になりつつある」 |
| Telegram | 「IBKR / Futuアクセス：韓国株の発見層に何が変わるか」 |
| X / Notes | 「韓国がETF一択から個別株選別市場へ移行しつつあるかもしれない」 |
| Google / IndexNow | ハブ＋記事URLを即時送信 |
| 内部リンク | スタートページ・日次マーケット・金融・HBM・AI PCBページにハブを追加 |

### 6.4 正しい指標を追う

これは測定可能だ。ウォッチリストはシンプルだ：

- 「IBKR 韓国株」のインプレッション数
- 「韓国株の買い方」のインプレッション数
- 「KOSPI vs KOSDAQ」のインプレッション数
- 米国・シンガポール・香港・日本・ベトナムからの海外トラフィックシェア
- AI PCB・HBM・Pearl Abyss・K-ビューティーハブへのクリック数
- Substackからのサイトへのリファラルトラフィック
- Telegramの英語見出しのクリックスルー率

これらの指標が動けば、直接的な検索クリックとして現れる前に、テーゼが機能していることを示す。
...
そこにKorea Invest Insightsが競争できる領域がある。「韓国を買え」と叫ぶのではなく、地図を描くことだ：KOSPI・KOSDAQ・Samsung Electronics・SK Hynix・HBM・AIサブストレート・Pearl Abyss・韓国金融株・K-ビューティー・そして日々のマーケットテープ。
