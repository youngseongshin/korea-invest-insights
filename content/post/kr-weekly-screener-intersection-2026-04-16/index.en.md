...
## Why "Screener Intersection" Is a Different Kind of Signal

Most quantitative screens answer one question at a time: *Is this stock cheap? Is momentum turning? Are insiders accumulating?* The answers are useful in isolation, but individually noisy. A stock can look cheap because it is genuinely overlooked — or because earnings are about to collapse. A momentum breakout can reflect real fundamental improvement or a one-day squeeze with no follow-through.

The intersection approach flips the logic. Instead of asking whether a stock passes *a* filter, it asks how many *independent* filters — each designed around a different market regime and a different underlying assumption — return the same name. A stock that surfaces in a mean-reversion model, a post-earnings-drift model, a quality-compounder model, *and* a quiet-accumulation model at the same time is not just cheap, or just revising, or just being accumulated. It is all of those things simultaneously. That convergence across uncorrelated frameworks is harder to explain away.

This report covers the week of April 9–16, 2026. We ran 10 independent screeners across 459 unique Korean-listed names over up to three daily snapshots each, totaling over 1,300 data points. The 15 names in the leaderboard below appeared in the most screeners with the highest combined hit counts. The top 5 are analyzed in depth.

---

## The Ten Screeners at a Glance
...
## Cross-Screener Leaderboard — Top 15 (Week of Apr 16, 2026)

| Rank | Ticker | Name | Screeners | Total Hits | Combination |
|---|---|---|---:|---:|---|
...
| Operating Profit | ₩8.8 trillion |
| Net Income | ₩8.8 trillion |
| Revenue YoY | +77.8% |
...
### 2. Semyung Electric (KOSPI: 017510) — 6 Screeners, MR + PEAD Dual Signal
...
### 4. Microcontact Solutions (KOSDAQ: 098120) — 5 Screeners including Quiet Accumulation
...
### 5. Woowon Development (KOSPI: 046940) — 5 Screeners, Extreme Turnaround
...
## Investment Implications: Why Intersection Screening Matters
...
## Bull and Bear Considerations by Name

| Ticker | Bull Case | Bear Case |
|---|---|---|
| 017510 Semyung Electric | Grid capex super-cycle sustains 40%+ margins; PER expands to 20–25× on visibility | Project concentration risk; margin normalization as competition enters |
| 046940 Woowon Development | PER/PBR normalization alone implies 3–5× upside; foreign accumulation accelerating | Construction cycle turns; high debt ratio amplifies downside; earnings quality uncertain |
| 000660 SK Hynix | HBM pricing power + AI server buildout sustains HBM3E/HBM4 margin premium | DRAM commodity oversupply returns; US export controls tighten on advanced memory |
| 402340 SK Square | Holding discount narrows; SK Hynix re-rating flows through; buybacks | Holding discount widens; Hynix correction disproportionately hurts NAV |
| 098120 Microcontact | Backend semiconductor intensity rises with AI chip complexity; niche pricing power | 60-day +100% has pulled forward much of the re-rating; customer concentration |
