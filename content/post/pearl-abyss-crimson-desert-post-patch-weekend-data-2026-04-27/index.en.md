---
title: "Pearl Abyss / Crimson Desert — Post-Patch Weekend Data: Why a -13% CCU Decay Is Actually Thesis-Confirming"
...
> **Series — Pearl Abyss Crimson Desert Thesis (Part 9)**
> Part 8 argued the thesis has moved from *"how many copies sold"* to *"can Pearl Abyss be re-rated as a global AAA platform / proprietary-engine company."* This post is the **first full weekend dataset after patch 1.04.00 + hotfix 1.04.02** — a clean read on whether the thesis is holding.
...
| Window | Range (KST) |
|---|---|
| **This weekend** | 2026-04-25 00:00 → 2026-04-27 00:00 |
| **Prior weekend** | 2026-04-18 00:00 → 2026-04-20 00:00 |
...
| **Avg CCU, zero-excluded** | **96,173** | 110,791 | **-13.2%** |
| Median CCU | 91,454 | 106,803 | -14.4% |
| **Peak CCU** | **134,188** | 155,732 | -13.8% |
| New positive reviews | 1,518 | 1,609 | -5.7% |
| **New negative reviews** | **221** | 439 | **-49.7%** |
| New review total | 1,739 | 2,048 | -15.1% |
| **New-review positivity** | **87.3%** | 78.6% | **+8.7pp** |
...
| **Daily run-rate, 70/30** | **21.9K/day** | 23.3K/day | -5.7% |
| **Daily run-rate, 52/48** | **29.5K/day** | 31.3K/day | -5.7% |
