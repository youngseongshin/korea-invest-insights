...
- 매출 런레이트(리뷰 기반 추정) 감소폭은 <strong>-5.7%</strong>에 그친 반면 CCU는 **-13.2%** 하락했다. 이 비대칭이 바로 롱테일 내구성의 시그니처이며, 플랫폼 리레이팅 테제가 필요로 하는 바로 그 패턴이다.
...
1. **패치 1.05.00** — 패치 후 D+1 CCU 반등이 <strong>≥+5%</strong>인가?
2. **신규 리뷰 긍정률** — <strong>90%</strong>를 지속적으로 재돌파하는가?
