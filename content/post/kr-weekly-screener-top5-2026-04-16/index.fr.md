---
title: "Top 5 du Screener Actions Coréennes : 16 avr. 2026"
date: 2026-04-18T09:00:00+09:00
slug: "kr-weekly-screener-top5-2026-04-16"
description: "Cinq actions coréennes ayant passé plusieurs filtres quantitatifs indépendants durant la semaine du 9 au 16 avril 2026 — méthodologie, métriques et cadre de risque pour les investisseurs internationaux."
...
## Pourquoi le Filtrage par Intersection est Décisif
...
Sepong Electric présente ce que le cadre de filtrage désigne comme une configuration de « grand chelem réversif » : une correction significative (−16,9 % par rapport au plus haut sur 52 semaines) a remis à zéro le sentiment et la valorisation, tandis que la société a simultanément livré une hausse de son résultat opérationnel de +393 % en glissement annuel — une surprise bénéficiaire d'une amplitude qui déclenche typiquement un PEAD. Cette combinaison crée un double vent porteur : le régime de retour à la moyenne est soutenu par la valorisation (PER 12,2×, PBR 1,73×), tandis que le régime PEAD est soutenu par l'accélération des bénéfices elle-même. Les investisseurs étrangers ont ajouté 1,56 point de pourcentage de participation sur les 20 derniers jours de bourse, un rythme d'accumulation notable pour une petite capitalisation du KOSDAQ.

### Observations Techniques

Les niveaux graphiques clés observés incluent la MM20 à ₩9 600 et la MM60 à ₩9 000. Le plus haut sur 52 semaines de ₩12 280 se situe environ +20 % au-dessus du prix actuel de ₩10 200, constituant un niveau de référence naturel pour évaluer l'ancienne résistance. Le MACD est entré en phase de croisement positif à la date du scan.

### Cadre de Risque

Sepong Electric est une valeur KOSDAQ de petite à moyenne capitalisation, avec une liquidité quotidienne limitée en conséquence. La hausse de +393 % du résultat opérationnel doit être évaluée à l'aune de sa durabilité cyclique — déterminer si l'amélioration de la rentabilité représente un changement structurel ou un pic sur une période constitue une variable déterminante. Le risque de concentration sur titre unique est plus élevé que pour les grandes capitalisations du KOSPI.
...
Woowon Development a passé cinq filtres : PEAD, Accumulation Discrète et trois variantes Smart Money. Le signal d'Accumulation Discrète est particulièrement notable : il est conçu pour détecter l'accumulation institutionnelle *avant* que le marché la valorise globalement, en s'appuyant sur des analyses de flux d'ordres et de positionnement plutôt que sur le seul cours.
...
Woowon Development présente sans doute l'anomalie de valorisation la plus extrême du scan de cette semaine. Un PER de 1,9× combiné à un ROE de 36,8 % est une configuration rare : par la mesure la plus simple du rapport cours/bénéfices relatif au rendement des capitaux propres, l'action est valorisée comme si sa rentabilité était transitoire ou structurellement défaillante — pourtant la période la plus récente affiche une progression du résultat opérationnel de +2 300 % et du résultat net de +6 757 % en glissement annuel. Le signal d'Accumulation Discrète suggère que cette divergence entre le cours et les fondamentaux n'a pas encore été globalement reconnue. Le PBR de 0,58× signifie que l'action se négocie en deçà de la valeur de liquidation de ses actifs nets comptables.

### Observations Techniques

Les niveaux graphiques clés incluent la MM60 à ₩4 400. Niveaux de référence de scénario dérivés de la modélisation par PER : un re-rating à PER 2,3× implique un cours aux alentours de ₩6 000 (+18 % par rapport au prix actuel) ; un re-rating à PER 2,8× implique environ ₩7 500 (+48 %). Ce sont des *niveaux de scénario illustratifs*, et non des objectifs de cours.

### Cadre de Risque

Les cycliques de la construction figurent parmi les valeurs les plus sensibles aux taux d'intérêt coréens et au sentiment du marché immobilier. Une détérioration des conditions de crédit domestique pourrait rapidement inverser le momentum des bénéfices. La liquidité est limitée par rapport aux valeurs du marché principal du KOSPI.
...
SK Hynix est le leader mondial coréen de la DRAM et de la HBM (High Bandwidth Memory), l'architecture mémoire au cœur des systèmes d'accélérateurs IA. L'intersection des filtres reflète une convergence de facteurs fondamentaux et de flux. Les investisseurs étrangers avaient été vendeurs nets sur la fenêtre de 20 jours (−₩2 200 Mds), mais ont opéré un retournement marqué à +₩2 547 Mds d'achat net sur le dernier snapshot de 5 jours. Simultanément, les institutions domestiques ont maintenu une accumulation régulière à +₩1 952 Mds sur 10 jours. Cette divergence puis convergence des flux étrangers est ce que les filtres Smart Money sont calibrés à détecter comme une potentielle transition de régime. Le PER prévisionnel de 5,0× face à un ROE de 44,1 % constitue l'ancrage fondamental.

### Observations Techniques

La MM20 se situe à ₩960 000, soit un écart d'environ −15,5 % par rapport au prix actuel de ₩1 136 000. Les approches de nouveaux plus hauts sur 52 semaines présentent typiquement une volatilité à court terme élevée. Une consolidation ou un repli post-cassure est un schéma courant dans ces configurations.

### Cadre de Risque

SK Hynix est directement exposée aux restrictions commerciales américano-chinoises sur les semi-conducteurs, à la dynamique de change won coréen/dollar et à la cyclicité de l'industrie mondiale de la mémoire. La détérioration macro reste le principal risque systémique.
...
Les niveaux graphiques clés incluent la MM20 à ₩620 000 et la MM60 à ₩550 000. Un niveau de réentrée de référence potentiel serait un retournement de la tendance des flux étrangers sur 20 jours, qui affiche actuellement une vente nette. La proximité de la borne supérieure des Bandes de Bollinger est notée.

### Cadre de Risque

Les décotes des holdings coréennes sont structurellement persistantes. La valorisation de SK Square est dérivée de la performance de SK Hynix, portant tous les risques macro de SK Hynix avec une couche supplémentaire de risque inhérente à la structure holding.
...
Pharmicell est une société biopharmaceutique coréenne spécialisée dans la thérapie cellulaire. Sa double accumulation institutionnelle — les investisseurs étrangers ajoutant +₩19,5 Mds et +2,69 points de pourcentage de participation tandis que les institutions domestiques ajoutent simultanément +₩11,3 Mds sur 20 jours — représente la configuration de flux de fonds la plus forte de tout le scan. Ce type de convergence institutionnelle bidirectionnelle est précisément ce que les filtres Smart Money sont calibrés à détecter. Un OP en hausse de +630 % et un NI de +540 % en glissement annuel fournissent un ancrage fondamental ; le ROE de 38,3 % compense partiellement la prime de valorisation du PBR à 8,67×.

### Observations Techniques

MM60 à ₩15 500. Borne supérieure des Bandes de Bollinger à environ ₩18 015 ; prix actuel à ₩17 900 = 97 % de la largeur de la bande. Le plus haut sur 52 semaines est à ₩19 270 (+7–8 % par rapport au prix actuel). Le niveau de référence de scénario à ₩22 000 (+23 %) représenterait un scénario d'expansion des Bandes de Bollinger en breakout si la bande s'élargit.

### Cadre de Risque

Les valeurs biotechnologiques comportent un risque d'événement binaire lié aux étapes cliniques, aux approbations réglementaires et aux actualités du pipeline. Le PBR de 8,67× laisse une marge de valorisation limitée en cas de révision à la baisse des bénéfices.

---

## Matrice Illustrative de Diversification par Régime

| Rang | Valeur (Ticker) | Nb de Filtres | Régime Principal | PER Prévisionnel | Flux Étrangers (20 j.) |
|---:|---|---:|---|---:|---|
| 1 | Sepong Electric (017510) | 6 | Retour à la Moyenne + PEAD | 12,2× | +1,56 pp |
| 2 | Woowon Development (046940) | 5 | Accumulation Discrète + Deep Value | 1,9× | +0,83 pp |
| 3 | SK Hynix (000660) | 5 | Momentum en Breakout | 5,0× | +₩2 550 Mds (retournement 5 j.) |
| 4 | SK Square (402340) | 7 | Tous Régimes (Re-rating Holding) | 4,0× | −₩223,6 Mds |
...
| Exclu | Raison Principale |
|---|---|
| Ubiqus (264450) | Participation étrangère −2,08 pp sur 20 jours — flux de fonds défavorables |
| Microcontact Sol (098120) | +100,8 % sur 60 jours + RSI 67,6 + dépassement de la borne supérieure Bollinger = surchauffe |
| April (278470) | PBR 34× — prime trop extrême malgré des fondamentaux solides |
| Company K (307930) | ROE 9,2 % + participation étrangère 1,36 % — qualité et liquidité en deçà du seuil |
...
## Conclusion : Pourquoi l'Intersection est l'Unité d'Analyse Pertinente

L'investissement mono-filtre comporte un mode d'échec spécifique : chaque filtre a un taux de faux positifs, et dans un univers de centaines de valeurs, même un taux de 5 % génère des dizaines de candidats trompeurs. La solution n'est pas de construire un meilleur filtre unique — c'est d'exiger qu'un candidat survive simultanément à plusieurs tests de résistance indépendants.

Lorsque Sepong Electric passe à la fois un filtre de retour à la moyenne (exigeant une baisse de prix) et un filtre PEAD (exigeant un momentum post-surprise bénéficiaire), ce n'est pas une coïncidence. Cela signifie que l'action a passé simultanément un filtre attendant une faiblesse des cours et un filtre attendant une hausse — parce qu'elle offre les deux : une valorisation réinitialisée et une base bénéficiaire en accélération. C'est une thèse plus durable que l'un ou l'autre signal pris isolément.

Les cinq valeurs présentées cette semaine couvrent cinq régimes d'investissement distincts avec une faible corrélation mutuelle. Cette diversification est elle-même un produit de la méthodologie : lorsqu'on filtre pour la validation multi-facteur sur des filtres diversifiés par régime, on fait naturellement émerger un ensemble de résultats diversifié par régime. Les questions ouvertes — si les filtres en intersection sont véritablement indépendants, et comment le taux d'intersection se corrèle aux rendements prévisionnels dans les conditions du marché coréen — restent des points à approfondir via des backtests en cours, et nous les signalons explicitement comme des points à l'ordre du jour ouverts à chaque publication hebdomadaire.
