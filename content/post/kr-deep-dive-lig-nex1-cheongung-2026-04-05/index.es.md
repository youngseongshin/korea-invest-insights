---
title: "LIG Nex1: El Gigante Surcoreano de la Defensa Antimisiles Apunta al Auge en Medio Oriente"
...
tags:
  ...
  - "Cheongung"
  - "천궁-II"
  - "acciones defensa coreana"
  - "K-defense"
  - "defensa antimisiles"
  - "armamento Medio Oriente"
  - "KOSPI"
  - "acciones coreanas"
  - "exportaciones defensa"
  - "defensa EAU"
  - "defensa Arabia Saudita"
  - "MANPADS"
  - "M-SAM"
description: "LIG Nex1 (079550.KS) se encuentra en la intersección de la creciente demanda de defensa aérea en Medio Oriente y la escalada de tensiones entre Estados Unidos e Irán. Todo lo que los inversores internacionales necesitan saber."
series: "K-Defense Deep Dives"
draft: false
---

## Tensiones al alza, pedidos al alza: LIG Nex1 en el centro del tablero

Cuando las negociaciones nucleares entre Washington y Teherán colapsaron en abril de 2026 y la administración Trump comenzó a señalar abiertamente la posibilidad de ataques militares contra las instalaciones nucleares iraníes, una empresa quedó en el epicentro del shock de demanda resultante: LIG Nex1 (079550.KS), el principal fabricante surcoreano de armas de precisión y sistemas de defensa antimisiles.

LIG Nex1 no es un nombre conocido fuera de la comunidad de defensa de Corea, pero ocupa un lugar central en lo que los analistas denominan el "superciclo K-defense". La compañía fabrica el Cheongung-II (천궁-II, también denominado M-SAM), un sistema de misiles tierra-aire de alcance medio que se ha consolidado como una de las alternativas de exportación más creíbles al Patriot PAC-2/PAC-3 estadounidense. Con una cartera de pedidos que supera los 15 billones de wones —un récord para la empresa— y una serie de negociaciones activas que se extienden desde la Península Arábiga hasta Europa del Este, el entorno geopolítico actual actúa como un acelerador inequívoco de la demanda.
...
| Producto | Tipo | Mercados de exportación clave |
|---|---|---|
| Cheongung-II (M-SAM) | Misil tierra-aire de alcance medio | EAU, Arabia Saudita, Iraq (en negociación) |
| Bigeung (비궁) | Sistema portátil de defensa antiaérea (MANPADS) | Múltiples; demanda disparada tras Ucrania |
| Haesong (해성) | Misil crucero buque-buque / buque-tierra | Armada de Corea del Sur; negociaciones de exportación en curso |

El Cheongung-II es la joya de la corona. Desarrollado conjuntamente con la Agencia para el Desarrollo de la Defensa (ADD), está diseñado para interceptar aeronaves, helicópteros, misiles crucero y misiles balísticos de corto alcance a altitudes de entre 40 metros y 15 kilómetros. Emplea guía por radar activo y es interoperable con la red KAMD (Korean Air and Missile Defense) de Corea del Sur.

---

## El catalizador EE.UU.-Irán: por qué el momento importa
...
| Indicador | Valor |
|---|---|
| Ingresos 2025 | KRW 3,2 billones |
| Cartera de pedidos (récord) | KRW 15 billones+ |
