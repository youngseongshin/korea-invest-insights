...
Precio promedio corto = facturación corta ÷ volumen corto:

```
KRW 3.491.300.350 ÷ 64.362 = KRW 54.244,7 → 54.245
```

Cierre vs. promedio corto:
...
## 3. Las últimas 10 sesiones

| Fecha | Vol. corto | Facturación corta | Precio prom. corto | Exento uptick | Posición corta neta |
|---|---:|---:|---:|---:|---:|
| 4/21 | 64.362 | 3,491B | 54.245 | 14,0% | pendiente |
| 4/20 | 86.097 | 4,668B | 54.224 | 24,6% | pendiente |
...
## 4. Lecturas estructurales en la ventana de 10 días

### 4.1 La intensidad corta se desplomó tras el pico del 16 de abril

Trayectoria del volumen corto:
...
```
Δ = 298.379 − 64.362 = 234.017 acciones
...
## Apéndice: Verificaciones aritméticas

### Precio promedio corto de hoy

```
3.491.300.350 ÷ 64.362 = 54.244,7 → 54.245
```

### Ratio exento de uptick de hoy

```
8.993 ÷ 64.362 = 13,97% → 14,0%
```

### Caída desde el pico del 4/16 hasta hoy

```
(298.379 − 64.362) ÷ 298.379 = 78,4%
```

### Descenso de posición corta neta del 4/16 al 4/17

```
1.912.458 − 1.876.700 = 35.758 acciones
```
