...
|---|---|---|---|
| **KOSPI** | 6 417,9 | +3,1 % | ↑ Haussier |
| **KOSDAQ** | 1 181,1 | +1,6 % | → Neutre |
| **USD/KRW** | 1 477 | +0,2 % | → Stable |
| **VIX** | 19,1 | +6,6 % | 🟢 Sous contrôle |
| **US 10Y** | 4,29 % | +0,01 pp | → Stable |
| **Brent** | 94,0 $ | +4,0 % | ↑ Tension |
| **DXY** | 98,3 | +0,2 % | → Stable |
...
| [003570.KS] | SNT다이내믹스 | 57 300 ₩ | **+3,29 pp** | 7,4 % | 12,0 % | +15,9 % | +1,37 |
...
**극동유화 (014530.KS) — Score +1,14 | Δ étranger +4,02 pp en 20j**
...
**고려산업 (002140.KS) — Score +0,79 | Δ étranger +2,80 pp**
