...
1. Le marché tend encore fortement à percevoir Samsung Electro-Mechanics comme une entreprise de MLCC smartphone et de modules caméra.
2. Les condensateurs silicium constituent une catégorie distincte, et leur intégration dans les modèles sell-side prend du temps.
3. La reconnaissance des revenus du contrat commence en 2027–2028, ce qui retarde leur impact sur le BPA à court terme.
4. Le client n'étant pas divulgué, il est impossible de déterminer si la commande provient de NVIDIA, Google ou d'un ASIC Broadcom/Marvell.
