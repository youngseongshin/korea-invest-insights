...
> Partie 1 : [SEMCO — « L'infrastructure invisible du silicium IA » (MLCC / FC-BGA / Optique, analyse approfondie, 15 mai)](/post/samsung-electro-mechanics-mlcc-fcbga-ai-infrastructure-deep-dive-2026-05-15/)
> Partie 2 : [SEMCO, le challenger hybride — Entre Murata et Ibiden, ce qu'implique 1 010 000 KRW pour le résultat opérationnel 2027E (17 mai)](/post/samsung-electro-mechanics-hybrid-challenger-2026-05-17/)
> Objectif Mirae à 1 300 000 KRW : [Le changement de cadre de valorisation (7 mai)](/post/samsung-electro-mechanics-mirae-tp-1300000-valuation-frame-shift-2026-05-07/)
> Premier appel de re-rating : [Reclassification en valeur de composants d'infrastructure IA (21 avr.)](/post/samsung-electro-mechanics-ai-infrastructure-rerating-2026-04-21/)
...
## 1. Le contrat en chiffres

### 1.1 Les données clés
...
| ---: | ---: | ---: | ---: |
| 15 % | \~116,8 Mds KRW | \~88,7 Mds KRW | \~+1 188 KRW |
| 20 % | \~155,7 Mds KRW | \~118,3 Mds KRW | \~+1 584 KRW |
| 25 % | \~194,6 Mds KRW | \~147,9 Mds KRW | \~+1 980 KRW |
| 30 % | \~233,6 Mds KRW | \~177,5 Mds KRW | \~+2 376 KRW |
| 40 % | \~311,4 Mds KRW | \~236,7 Mds KRW | \~+3 169 KRW |

À une marge opérationnelle de 30 %, ce seul contrat ajoute \~2 400 KRW au BPA — soit environ 10 % de hausse par rapport au BPA 2027E de référence de Hana Securities, établi à 22 874 KRW. La marge réelle dépend des rendements en phase initiale, des amortissements, des conditions tarifaires client, du coût de la tranche wafer et des coûts de test.

---

## 2. Évolution du cours — 20 et 21 mai

### 2.1 Séance régulière du 20 mai
...
### 2.3 Flux — les institutionnels absorbent les prises de profit des étrangers

Flux du 20 mai : étrangers -111 248 actions / institutionnels +82 167 actions. Ce schéma — « les institutionnels en cours de re-rating absorbent les prises de profit étrangères » — n'est pas une vague thématique d'un jour, surtout combiné à la hausse de +56,0 % sur un mois du 20 avril au 20 mai.

---

## 3. Pourquoi il s'agit d'un événement de reclassification

### 3.1 Le goulot d'étranglement que le Si-Cap résout — l'intégrité de puissance
...
### 3.4 Barrière de qualification élevée — ancrage durable une fois certifié

La fiabilité du Si-Cap est liée à la fiabilité globale de l'emballage IA. Un défaut n'est pas un problème au niveau du composant ; il devient un problème de fiabilité au niveau du package GPU / ASIC. La qualification est donc longue, et la conception intégrée difficile à inverser. Les rapports soulignent que le secteur reste concentré autour d'un petit nombre de fournisseurs qualifiés, précisément pour cette raison.
...
## 5. Ce que le cours actuel intègre — et ce qu'il n'intègre pas

### 5.1 Situation actuelle

| Élément | Valeur |
| --- | ---: |
| Clôture du 20 mai | 1 061 000 KRW |
| Pré-marché du 21 mai | 1 109 000 KRW |
| Capitalisation boursière | \~72 200 Mds KRW |
| Actions en circulation | 74 693 696 |
...
| Fourchette de cours | Lecture | Recommandation |
| ---: | --- | --- |
...
## 6. Recommandation opérationnelle — différenciée selon le profil
...
- Résultats T2 ou T3 montrant des gains d'ASP sur FC-BGA / MLCC
- Divulgation d'un nouveau client Si-Cap
- Preuve qualitative ou quantitative d'une marge opérationnelle Si-Cap de 25–30 %+
- Consensus BPA 2027E révisé au-dessus de 28 000 KRW
...
Réévaluer la recommandation sur l'un des événements suivants :

- Amendement de la divulgation réduisant le montant ou la durée du contrat
- Glissement de la reconnaissance Si-Cap 2027 vers 2028
- Marge opérationnelle Si-Cap confirmée inférieure à 20 %
- Retournement du cycle tarifaire FC-BGA ou MLCC
- Concentration client unique supérieure à 70 % sans visibilité sur le renouvellement post-2028
- Problèmes de rendement suite à un CAPEX élevé
...
*Cet article est une analyse et un commentaire à caractère informatif uniquement et ne constitue pas un conseil en investissement. La divulgation du contrat de 1 557,0 Mds KRW (20 mai 2026 ; durée du 1er janv. 2027 au 31 déc. 2028) est tirée du dépôt officiel de la société. Le montant de 1 035,4 M USD au taux de change de 1 503,8 KRW/USD est issu du document annexé à la divulgation. Le CA FY2025 de 11 314,5 Mds KRW et le RO de 913,3 Mds KRW proviennent du communiqué officiel de la société. La clôture du 20 mai à 1 061 000 KRW, la clôture du 19 mai à 987 000 KRW et le pré-marché du 21 mai à 1 109 000 KRW sont issus du KRX, de Naver Finance et d'Investing.com. Le CA 2026E / RO 2026E / BPA 2026E / PER 2026E reflètent le consensus Naver Finance / FnGuide et sont susceptibles d'évoluer. L'objectif de 1 500 000 KRW de SK Securities, l'objectif de 810 000 KRW de Hana Securities et le BPA 2027E de 22 874 KRW proviennent des rapports respectifs de chaque courtier. Les reportages relatifs à Marvell (19 juin 2025 via Yonhap et autres) ne constituent pas une preuve identifiant la contrepartie du présent contrat. Le chiffre de \~2,3 Mds USD pour le marché mondial des condensateurs silicium (2026) fait référence à Mordor Intelligence. Le tableau de sensibilité aux marges opérationnelles (15–40 %) repose sur les hypothèses de l'auteur ; les marges réelles ne sont pas divulguées. Les lectures par fourchette de cours, les conditions d'entrée et les conditions de remise en cause de la thèse reflètent les vues de l'auteur et ne sont assorties d'aucune garantie. Les variables macroéconomiques mondiales (taux américains, pétrole, change, VIX) peuvent influencer le titre indépendamment. L'analyse peut être erronée. Données arrêtées au 21 mai 2026, 08h30 KST.*
