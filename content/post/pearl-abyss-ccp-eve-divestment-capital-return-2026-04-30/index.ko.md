...
description: "펄어비스가 CCP게임즈 지분 전량을 1,771억 원에 매각한다. 시총 대비 4.7%, 주당 현금성 가치 2,757원의 이벤트다. 매각 자체만으로 fair value 추정 범위가 크게 달라지지는 않지만, 매각대금이 자사주 매입·소각으로 연결되면 기존 75,000원 중심 범위가 78,000~82,500원 수준으로 재조정될 수 있다. 2026년 상법 개정이 자사주 처리 압력을 구조적으로 높였다는 점에서, 이번 공시의 본질은 매각이 아니라 자본배치 원칙 시험대다."
...
핵심 변수는 매각대금 사용처와 자사주 처리방식이다. 기존 자사주 약 282.8만 주, 4.4% 소각과 CCP 매각대금 일부 자사주 매입·소각이 결합되면, 기존 fair value 추정 범위는 **78,000~82,500원** 수준까지 재조정될 수 있다.
...
| 기존 fair value 추정 범위 75,000원 중심 → 주주환원 반영 시 | 78,000~82,500원 |
...
즉 주주환원이 강하게 발표되면 75,000원 중심의 fair value 추정 범위는 **78,000~82,500원** 수준으로 재조정될 수 있다.
...
이번 공시의 본질은 1,771억 원의 현금 이벤트가 아니라, 펄어비스 자본배치 원칙의 시험대다. 매각 자체는 +3~5% 수준의 재평가 요인이지만, 매각대금이 자사주 소각으로 연결되고 기존 자사주 처리계획이 “소각” 방향으로 정해지는 조합이 나오면 75,000원 중심의 fair value 추정 범위는 **78,000~82,500원** 수준으로 재조정될 수 있다.
