...
| **Sector** | Semiconductores y equipos de semiconductores |
| **Sede** | Icheon, Gyeonggi-do, Corea del Sur |
| **Grupo matriz** | SK Group (a través de SK Square) |
| **Productos clave** | DRAM, HBM (High Bandwidth Memory), NAND Flash, SSD empresarial (Solidigm) |
| **Capitalización bursátil** | Aprox. KRW 100–120 billones (USD 70–85 mil millones a tipos de cambio recientes) |
...
**1. La expansión de la infraestructura de IA**
...
**2. El superciclo del SSD empresarial**
...
**3. Recuperación de la memoria convencional y renegociación de contratos a largo plazo**
...
|---|---|---|
| **iShares MSCI South Korea ETF (EWY)** | Corea amplio | Top-5 en posiciones |
| **VanEck Semiconductor ETF (SMH)** | Semiconductores globales | Posición menor; verifique posiciones actuales |
| **Franklin FTSE South Korea ETF (FLKR)** | Corea ponderado por capitalización | Ponderación significativa |
| **ETFs centrados en Corea en bolsas locales** | Varios | A menudo 5–10%+ |
...
**¿Cómo puedo comprar acciones de SK hynix?**
