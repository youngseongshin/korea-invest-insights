...
## 1. Bottom Line First — The Two Endpoints That Define the Landscape

### 1.1 Full Map of the Six-Company Series

Pulling every coordinate the series has visited, with Part 6 added:

| Series | Company | 2026E ROE | 2026E PBR | Implied cost of equity | Model identity | Analytical dimension |
| --- | --- | ---: | ---: | ---: | --- | --- |
| Part 1 | Meritz Financial Holdings | 22.4% | 1.94× | 11.5% | Capital-buyback compounder | Peak |
...
| Item | Value |
| --- | ---: |
| April 30, 2026 close | ₩24,350 |
| 2025 EPS / BPS | ₩1,007 / ₩14,166 |
| 2025 P/E / P/B | 24.18× / 1.72× |
| 2026E EPS / BPS (consensus) | ₩1,246 / ₩14,936 |
| 2026E P/E / P/B (consensus) | 19.55× / 1.63× |
| 2026E EPS / BPS (LS Securities) | ₩1,131 / ₩14,880 |
...
| CIR | 36.9% |
| NPL ratio / Credit cost | 0.51% / 0.55% |
| 2025 DPS / dividend yield | ₩460 / 1.89% |
| 2025 total shareholder-return ratio | 45.6% |
| Company 2030 ROE target | 15.0% |
| Company Fee & Platform CAGR target | 20.0% (2025–2027) |

Verifications:
- PBR = 24,350 / 14,166 = 1.7188 ≈ 1.72× ✓
- PER = 24,350 / 1,007 = 24.180 ≈ 24.18× ✓
- Implied cost of equity = 7.22 / 1.72 = 4.198% ≈ 4.20% ✓
- Dividend yield = 460 / 24,350 = 1.889% ≈ 1.89% ✓
- Operating revenue YoY = 3,086.3 / 2,945.6 − 1 = 4.78% ≈ 4.8% ✓
...
## 2. The Mirror-Image Comparison vs Korea Investment Holdings

### 2.1 Polar Opposite Positions

Putting Part 5's Korea Investment Holdings and Part 6's KakaoBank side-by-side makes the "mirror image" frame concrete in accounting terms.

| Item | Korea Investment Holdings (Part 5) | KakaoBank (Part 6) | Asymmetry |
| --- | ---: | ---: | --- |
| 2026E ROE | 18.5% (2025) | 7.22% (2025) | KIH +11.3 pp |
| PBR | 1.07× | 1.72× | KakaoBank +60.7% |
| Implied cost of equity | 17.3% | 4.2% | KIH +13.1 pp |
| Coordinate the company claims | Capital-operations platform | Mobile-financial platform + AI-native bank | — |
| Market's view | Conservative (discount) | Aggressive (premium) | Polar opposite |
| Verification direction | Fundamentals → coordinate recognition | Coordinate recognition → fundamentals verification | Polar opposite |
| What needs to close each quarter | Market reclassification | Company's ROE path | — |
| Cost-of-equity convergence direction | 17.3% → 14–15% (narrow) | 4.2% → 8–10% (defend) | Polar opposite |

Verification: cost-of-equity gap = 17.3 − 4.2 = 13.1 pp
...
But the *direction toward the separate coordinate* is opposite. Korea Investment is ahead of the market (the market has to catch up). KakaoBank is behind the market (the company has to catch up).

### 2.3 What "Two Directions of Coordinate Definition" Means Analytically
...
## 3. The "New Coordinate" KakaoBank Claims

### 3.1 Company IR Framework

KakaoBank's official Value-up frame:
...
The company has set 2027 targets: 30M customers, 25M MAU, ₩100T assets, Fee & Platform CAGR 20% over 2025–2027, and ROE 15% by 2030.

### 3.2 Verification Status of the Seven Supporting Arguments

The seven arguments KakaoBank presents for its "new coordinate," classified by verification stage:
...
Implied cost of equity 4.2% signals that the market has substantially priced in "all seven arguments succeeding." Solving via Gordon Growth:
...
Verified ① ② ⑦ alone don't justify PBR 1.63×. Compared with Meritz earning PBR 1.94× via 60%+ payout, KakaoBank's 45.6% payout × ROE 7.22% doesn't close the math.
...
| Premium factor | Accounting basis | Estimated impact |
| --- | --- | ---: |
| Mobile-financial traffic (verified) | MAU 20.0M, WAU 14.7M, nationwide penetration | \~−1.0 pp |
| Low-cost-funding infrastructure (verified) | Low-cost mix 57.1%, funding-cost advantage | \~−0.8 pp |
...
### 4.2 Mirror Image of Part 5 — Two Decompositions Side-by-Side

Putting both companies in one table reveals the polar decomposition:
...
### 4.3 Both Companies Converge to Normal Through the Same Mechanism

An interesting consistency: both companies can converge to "normal cost of equity" via the same broad mechanism.

```
Korea Investment Holdings: 17.3% → 14–15% (narrow toward normal)
...
Both move toward "near-normal cost of equity," but Korea Investment "narrows," while KakaoBank either "defends" or "catches up via ROE." Same chapter, two directions.

---

## 5. Verifying the Accounting Closure of Revenue/Profit Growth Rates

Part 5 verified Korea Investment's "qualitative consistency of operations +76.3%." Part 6 verifies KakaoBank's "consistency of growth-rate normalization."

### 5.1 Four-Year Growth Trajectory

| Year | Operating revenue | YoY | Net income | YoY |
| ---: | ---: | ---: | ---: | ---: |
...
### 5.2 Forward Growth — LS Securities Estimates

| Year | Total operating income | YoY | Net income | YoY | ROE |
| --- | ---: | ---: | ---: | ---: | ---: |
| 2025A | ₩1,411B | +2.9% | ₩480B | +9.1% | 7.2% |
| 2026E | ₩1,563B | +10.8% | ₩539B | +12.2% | 7.8% |
| 2027E | ₩1,689B | +8.1% | ₩582B | +8.1% | 8.1% |

Per LS Securities, KakaoBank's normalized profit-growth pace is +12% in 2026 and +8% in 2027. Comparing with the rest of the series:

| Company | 2026E net-income growth (or EPS) |
| --- | ---: |
| Meritz | EPS +13.6% (incl. buyback effect) |
| Kiwoom | quarterly slowdown, annual \~10% |
...
Using the 2026E consensus EPS ₩1,246 directly produces P/E 19.55×. But 1Q26 will likely include a Superbank mark-to-market gain of ₩93.0B in non-operating income.

```
Superbank pre-tax mark-to-market = ₩93.0B
...
The mechanism that closes that 3.1 pp gap:

```
Fee & Platform CAGR 20% recovery (currently +2.9%)
...
While Korea Investment Holdings (Part 5) had weak shareholder return as a discount factor (payout 25.1%), KakaoBank is moving sharply in the other direction (45.6% → 50%).

```
DPS 5-year trajectory:
...
Verification: DPS 5-year change: 460/80 = 5.75×, 3-year CAGR = 5.75^(1/3) − 1 = +79.2%
Payout-ratio change over 3 years: 45.6 − 14.5 = +31.1 pp

Comparing this mechanism with the rest of the series:

| Company | 2025 payout | Buyback-and-cancel | 5-year payout change |
| --- | ---: | --- | ---: |
| Meritz | 62.5% | Quarterly algorithm | At peak |
| KB | 83.0% (incl.) | Routine | Strong rise |
...
```
Accounting ROE 7.2% → 9–10% → 11%-class (Mechanism 1)
                ↕
...
## 7. The "New Coordinate Definition" Chapter — Meta Message

Part 5 introduced "new coordinate definition" as an analytical dimension. With Part 6 completing the second endpoint, the meta-message becomes clear.

### 7.1 Two Modes of "New Coordinate Definition"
...
### 7.2 The Landscape Visible When Both Are Read Together

This is where the series deepens by another layer.

```
Parts 1–3: Peak landscape
...
### 8.1 "Premium Self-Verification" vs "Premium Normalization"
...
### 8.2 The Meaning of the 17.1 pp Fee & Platform Gap

The gap between the company's Fee & Platform CAGR 20% guidance and 2025's actual +2.9% is 17.1 pp. The probability of closing this in one quarter is low — the company itself is clearly aware of it.
...
## 9. The Next Verification Step — Signals That Track Coordinate-Recovery Speed

Not trade triggers. Observation points that show how fast the "new coordinate recovery" is progressing.
...
Estimated cost-of-equity-defense impact for each:

| Trigger | Verification timing | Cost-of-equity defense impact |
| --- | --- | ---: |
| Fee & Platform growth +10% or above recovered | Quarterly IR | \~+0.5 pp defense |
| 2026 payout 50% achieved + part of buyback-and-cancel | 2026 year-end | \~+0.7 pp defense |
| ROE 9% or above on quarterly annualized basis | 1H26 cumulative | \~+1.0 pp defense |
...
*This post is research and commentary only, not investment advice. ROE / PBR / cost-of-equity / payout scenarios are based on sell-side estimates (LS Securities, Hanwha Investment & Securities, Samsung Securities, WiseReport, etc.), company IR materials, and corporate-value-up disclosures; actual outcomes may differ. The quantification of the five premium factors is the analyst's inference; the market's actual cost-of-equity decomposition may differ. Gordon-Growth-model assumptions (CoE 9%, payout 50%) are conservative anchors; actual values may vary. Tickers cited are illustrative for the framework, not recommendations. Do your own due diligence and consult licensed advisors before any investment decision.*
