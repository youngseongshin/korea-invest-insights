...
## 1. La découverte : les flux d'avril n'avaient rien de discret
...
## 2. Le métier actuel : 97 % biochimique, 56 % matériaux faible Dk

Les chiffres 2025 de Pamicell ne ressemblent pas à un profil biotech spéculatif.
...
En termes simples : le marché se souvient encore du passé biotech de Pamicell, tandis que la société génère désormais des marges de matériaux d'infrastructure IA.
...
## 4. La piste contractuelle : des commandes Doosan répétées

C'est là que la thèse devient plus concrète. La connexion Pamicell-Doosan n'est pas seulement une inférence thématique. Elle s'est matérialisée à travers des divulgations répétées de contrats d'approvisionnement.

| Date de divulgation | Contrepartie | Valeur du contrat | Période du contrat | Lecture transversale |
|---|---|---:|---|---|
| 2025-04-22 | Doosan Electronic BG | 4,58 milliards de wons | 22/04/2025 au 31/05/2025 | La demande liée au CCL IA devient visible |
...
## 5. Valorisation : pas bon marché sur les chiffres historiques, pas encore pleinement reclassifiée non plus

Sur la base du cours de référence du 30 avril :
...
| Indicateur | 2025A | Fourchette de base 2026E | Fourchette base/haussière 2027E |
|---|---:|---:|---:|
...
## 6. Le premier point de contrôle : résultats du 1T26

Le prochain catalyseur n'est pas un slogan. C'est le compte de résultat du 1T26.

Pour le 1T26, je surveille trois éléments.

| Point de contrôle | Ce qui confirmerait la thèse | Pourquoi c'est important |
|---|---|---|
| Résultat opérationnel | 13,5 à 15,5 milliards de wons, ou un autre trimestre à environ 30 % de marge | Confirme que la rentabilité 2025 n'était pas un accident comptable sur un an |
| Reconnaissance du CA Doosan | Reconnaissance significative du contrat de février 2026 | Relie la taille de la commande plus importante aux ventes déclarées |
| Discipline des coûts | Pas de dérive majeure des frais généraux ou des coûts de production | Détermine si la croissance des ventes se traduit encore en résultat opérationnel |

Le marché n'a pas besoin de perfection. Il a besoin de la confirmation que la piste contractuelle devient du chiffre d'affaires et que ce chiffre d'affaires conserve des marges de type CCL haut de gamme. Le prochain contrat est tout aussi important. Le contrat de février 2026 court jusqu'au 30 avril, donc une fenêtre de divulgation mai-juin est significative. Si le prochain contrat revient aux niveaux de 2025, le marché traitera février comme une anticipation de demande. S'il reste dans la fourchette haute en milliards de wons ou au-delà, la montée en régime du rythme de croisière devient bien plus crédible.
...
## 8. Le fossé de perception

La ligne centrale de cette thèse est la suivante :

> Tandis que le marché se souvient encore de « Pamicell la société de cellules souches », le compte de résultat ressemble de plus en plus à « Pamicell le fournisseur de matériaux CCL IA ».

Le fossé de perception comporte quatre couches.

| Couche | Ancien cadre | Nouveau cadre | État actuel |
|---|---|---|---|
| Structure des revenus | Biotech cellules souches | Matériaux biochimiques | Largement comblé |
| Rentabilité | Titre thématique ou optionnel | Matériaux spécialisés à 30 % de marge opérationnelle | Comblé en 2025, confirmation 2026 nécessaire |
| Canal client | Exposition aux matériaux floue | Contrats répétés avec Doosan Electronic BG | En cours de comblement |
| Identité de marché | Étiquette biotech | Proxy de matériaux d'infrastructure IA | Stade précoce |

Les deux premières couches ont déjà bougé. La troisième se déplace via les divulgations de contrats. La quatrième est du ressort du marché, et c'est généralement la couche la plus lente.

Les flux étrangers et institutionnels d'avril suggèrent que certains investisseurs ont commencé à opérer ce changement d'identité. La prochaine étape du titre dépend du fait que les résultats publiés et les nouveaux contrats obligent ou non le reste du marché à suivre.

## Note finale

Le signal le plus fort de mon filtre « argent intelligent » d'avril provenait d'une société que la plupart des investisseurs associent encore aux cellules souches. C'est précisément pourquoi Pamicell est intéressante.

La société n'a pas simplement ajouté une ligne de produits liée à l'IA à une vieille histoire biotech. Son mix de chiffre d'affaires 2025, son profil de marges et sa piste de contrats avec Doosan Electronic BG montrent que le centre de gravité économique a déjà basculé. Les matériaux faible Dk pour CCL haut de gamme ne sont plus une note de bas de page ; ils constituent le principal moteur de résultats.

La prochaine question n'est pas de savoir si l'ancienne étiquette est dépassée. Elle l'est. La prochaine question est de savoir à quelle vitesse le marché la remplace.

Si les résultats du 1T26 confirment des marges autour de 30 %, si le contrat Doosan de février apparaît dans le chiffre d'affaires, et si le prochain ordre Doosan reste près du nouveau rythme de croisière, la reclassification de « thème biotech » à « proxy de matériaux CCL IA » devient difficile à ignorer. Si ces vérifications échouent, les flux d'avril pourraient s'avérer avoir été précoces plutôt qu'avoir eu raison.

C'est la bonne façon d'aborder Pamicell à l'entrée de mai : non pas comme un simple signal d'achat ou de vente, mais comme une transition factorielle en cours où flux, contrats, marges et capacités doivent tous continuer à confirmer la même histoire. Les risques sont tout aussi clairs : concentration clientèle, calendrier des contrats, exécution des capacités et retournement brutal d'étiquette.

## Sources et notes de vérification

Les faits clés ont été recoupés avec les divulgations et les rapports du marché coréen. Vérifiez les dépôts en temps réel via DART et KRX.

- Site et actualités de Pamicell : [pharmicell.com](https://www.pharmicell.com/)
- Communiqué de Pamicell sur la rémunération des actionnaires avec les résultats 2025 : [Pamicell, 24 février 2026](https://www.pharmicell.com/pr/report_detail.php?seq=340)
- Contrat d'approvisionnement Doosan Electronic BG et mix matériaux 2025 : [Yakup, 19 février 2026](https://www.yakup.com/news/index.html?cat=12&mode=view&nid=323425)
- Investissement usine 3 d'Ulsan : [Asia Business Daily, 24 mars 2025](https://view.asiae.co.kr/news/view.htm?idxno=2025032415110844788)
