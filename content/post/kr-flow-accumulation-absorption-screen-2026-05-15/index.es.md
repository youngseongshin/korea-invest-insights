---
title: "Quién Absorbió la Caída del 15 de Mayo — El Filtro de Flujo Apunta a Hana Micron, HL Mando y Simtec"
date: 2026-05-17T00:55:00+09:00
categories: ["daily-wrap", "market-flow"]
tags:
  - "KOSPI"
  - "KOSDAQ"
  - "flujo inversor extranjero"
  - "flujo institucional"
  - "Hana Micron"
  - "HL Mando"
  - "Simtec"
...
Los datos cubren el flujo acumulado del 4 al 14 de mayo de 2026, combinado con el flujo de un solo día del 15 de mayo.
...
Candidatos finales del filtro: Hana Micron, HL Mando, Simtec, Jeju Semiconductor, Rainbow Robotics, y Hugel/GS Retail como ideas secundarias. En lugar de perseguir el impulso a corto plazo, el enfoque más racional es esperar retrocesos en los que la señal de flujo se mantenga.

---

## 1. El Patrón Más Sólido — Doble Acumulación Consecutiva

Los valores que se muestran a continuación forman el núcleo de este filtro. Extranjeros e instituciones compraron conjuntamente hasta el 14 de mayo y continuaron absorbiendo la oferta minorista el 15 de mayo — en un contexto de ventas extranjeras e institucionales generalizadas en todo el mercado. Ese contexto hace que la señal sea más significativa.

| Nombre | Rentabilidad hasta 5/14 | Variación 5/15 | Extr. acum. 5/14 | Inst. acum. 5/14 | Extr. 5/15 | Inst. 5/15 | Minorista 5/15 | Valoración |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| Rainbow Robotics | +22,8% | -3,69% | +₩252,7B | +₩64,0B | +₩6,0B | +₩15,2B | -₩20,1B | Mejor calidad de flujo, valoración exigida |
| Hana Micron | +6,1% | +18,61% | +₩30,4B | +₩4,6B | +₩91,8B | +₩1,6B | -₩93,8B | Candidato accionable más sólido |
| Jeju Semiconductor | +33,3% | +8,86% | +₩29,2B | +₩33,4B | +₩23,5B | +₩8,1B | -₩33,3B | Sólido pero sobrecomprado |
| HL Mando | +8,4% | -1,91% | +₩24,5B | +₩13,3B | +₩21,4B | +₩13,6B | -₩33,7B | Candidato de entrada más cómodo |
| Hugel | +9,2% | -1,05% | +₩26,4B | +₩5,5B | +₩3,4B | +₩1,9B | -₩5,1B | Defensivo, estable |
| GS Retail | +24,9% | +2,26% | +₩12,8B | +₩10,7B | +₩5,9B | +₩2,8B | -₩8,5B | Flujo de consumo básico intacto |
| Seegene | +30,6% | -2,97% | +₩24,1B | +₩4,1B | +₩2,3B | +₩2,1B | -₩4,6B | Posible movimiento por catalizador |
| POSCO DX | +0,8% | -5,47% | +₩11,6B | +₩6,5B | +₩2,8B | +₩1,1B | -₩3,8B | Perfil de absorción a precio bajo |
| RF Materials | +1,7% | -8,70% | +₩10,3B | +₩1,9B | +₩1,3B | +₩2,2B | -₩4,0B | Opción de pequeña capitalización |
...
## 2. Solo Semiconductores

Dentro de los semiconductores, el ranking es más nítido. Hana Micron lidera, Simtec le sigue, Jeju Semiconductor es sólido pero sobrecomprado, y Daeduck Electronics es un valor de calidad que queda más atrás en esta combinación de flujos concreta.
...
Simtec sigue mereciendo atención en el segmento de sustratos para semiconductores. El flujo acumulado hasta el 14 de mayo fue sólido y los extranjeros continuaron comprando el 15. La vacilación institucional es el principal motivo de preocupación. El próximo punto de confirmación es la reentrada institucional.

---

## 3. Valores donde los Extranjeros Absorbieron la Caída del 15 de Mayo

El siguiente grupo registró compras extranjeras el 15 de mayo, pero con un soporte institucional débil o mixto. Quedan por debajo del grupo de doble acumulación, pero se califican como candidatos de "absorción en el día del desplome" dignos de seguimiento.

| Nombre | Extr. acum. 5/14 | Extr. 5/15 | Inst. 5/15 | Interpretación |
|---|---:|---:|---:|---|
| Fadu | +₩103,2B | +₩56,4B | -₩14,6B | Extranjeros muy fuertes. Valoración exigida |
| KB Financial | +₩107,9B | +₩44,5B | -₩11,9B | Acumulación extranjera defensiva |
| SK | +₩152,8B | +₩28,1B | -₩19,8B | Apuesta a la revalorización de holding |
| POSCO Holdings | +₩148,4B | +₩19,0B | +₩5,9B | Perfil de absorción a precio bajo |
| Samsung Fire & Marine | +₩70,9B | +₩18,2B | +₩7,6B | Mejor nombre entre los defensivos |
| Hanmi Pharm | +₩44,0B | +₩10,8B | +₩19,9B | Absorción en farmacéutica de gran capitalización |
| Kolon Industries | +₩21,6B | +₩24,1B | -₩14,7B | Extranjeros compraron la caída, instituciones aún negativas |
| DL E&C | +₩71,6B | +₩14,6B | -₩3,2B | Compra de caída en construcción |
| Simtec | +₩66,6B | +₩12,6B | -₩7,6B | Extranjeros se mantuvieron, instituciones vacilaron |

Este grupo se caracteriza mejor como "absorción de caída" que como "continuación de tendencia". Fadu tiene un flujo extranjero muy sólido, pero la valoración es exigente. KB Financial y Samsung Fire & Marine son de naturaleza defensiva. Kolon Industries registró compras extranjeras agresivas, pero las instituciones siguen negativas.

La prioridad de compra es inferior a la del grupo de doble acumulación. Sin embargo, esta lista resulta útil para observar si los extranjeros mantienen sus posiciones durante el próximo movimiento de volatilidad del mercado.

---

## 4. Patrones a Evitar — Posible Distribución el 15 de Mayo

Los valores que parecían sólidos hasta el 14 de mayo pueden contar una historia muy diferente una vez incorporado el 15. Los nombres donde los extranjeros vendieron con fuerza aprovechando una subida de precio mientras el minorista absorbía la oferta deben quedar excluidos de la lista de nuevas ideas.

| Nombre | Extr. acum. 5/14 | Extr. 5/15 | Minorista 5/15 | Valoración |
|---|---:|---:|---:|---|
| LG Electronics | +₩337,2B | -₩261,0B | +₩256,3B | Venta extranjera intensa aprovechando el rally |
| Hyundai Motor | +₩103,6B | -₩202,8B | +₩195,3B | Instituciones se mantuvieron; extranjeros distribuyeron |
| Hyundai E&C | +₩222,5B | -₩15,2B | +₩30,1B | Flujo deteriorado el 15 de mayo |
| LG CNS | +₩54,2B | -₩44,1B | +₩16,6B | Instituciones absorbieron, pero extranjeros salieron |
| Philoptics | +₩44,7B | -₩0,5B | +₩0,8B | Candidato sólido degradado |
| Eugene Tech | +₩30,8B | -₩2,8B | +₩3,5B | Precio y flujo débiles |

LG Electronics es el ejemplo más claro. Los extranjeros habían acumulado +₩337,2B hasta el 14 de mayo. Luego, el 15 de mayo, los extranjeros vendieron -₩261,0B en una sola sesión mientras el minorista compraba +₩256,3B. Es una estructura de distribución clásica — extranjeros descargando posiciones aprovechando la fortaleza. Un valor que "era sólido" no es lo mismo que un valor "para descubrir ahora".

Hyundai Motor sigue el mismo patrón. Las instituciones mantuvieron su posición, pero los extranjeros vendieron -₩202,8B mientras el minorista compraba +₩195,3B. Cuando los extranjeros recortan posiciones de forma agresiva en un día bajista, la recuperación del flujo debe confirmarse antes de incorporar estos nombres como nuevos candidatos.

---

## 5. Candidatos Finales del Filtro
...
La primera es el líder de impulso-tendencia: Hana Micron. La intensidad de la compra extranjera el 15 de mayo fue dominante. No obstante, tras una subida de un solo día del +18,61%, la búsqueda inmediata conlleva un riesgo de volatilidad considerable.

La segunda es el nombre con mejor flujo y menor sobrecompra: HL Mando. Extranjeros e instituciones han sido compradores consistentes, y el valor aguantó relativamente bien durante la venta masiva. Ofrece el mejor equilibrio entre calidad de flujo y carga de precio.

La tercera es el candidato de sustratos para semiconductores: Simtec. El flujo es más moderado que el de Hana Micron, pero la doble acumulación acumulada hasta el 14 de mayo combinada con el interés extranjero sostenido el 15 es significativa. La reentrada institucional sería el catalizador para ascenderlo en la lista.

---

## 6. Reflexión Final

En un día de desplome como el 15 de mayo, la pregunta más importante no es "qué subió más" — sino "quién absorbió la oferta". En un contexto de mercado con extranjeros en -₩5,18T, instituciones en -₩1,88T y minoristas en +₩6,93T, un puñado de valores se movió en dirección contraria.

Desde ese criterio, los dos nombres con la estructura más limpia son Hana Micron y HL Mando. Hana Micron es la señal más potente; HL Mando ofrece la configuración más cómoda. Simtec es el secundario de sustratos para semiconductores, mientras que Jeju Semiconductor y Rainbow Robotics son convincentes pero conllevan un riesgo de perseguir el precio que no debe subestimarse.
...
*Este artículo tiene únicamente fines de investigación y comentario, y no constituye asesoramiento de inversión. Los datos de flujo se basan en los flujos acumulados del 4 al 14 de mayo de 2026 y en los flujos de un solo día del 15 de mayo de 2026. Las cifras de flujo extranjero, institucional y minorista pueden variar en función de la metodología de agregación de datos de bolsa y mercado. Un flujo sólido no garantiza una revalorización del precio. Los valores que han subido bruscamente en el corto plazo presentan una mayor volatilidad y riesgo de toma de beneficios. Este análisis puede estar equivocado. Fecha de referencia de los datos: 15 de mayo de 2026 KST.*
