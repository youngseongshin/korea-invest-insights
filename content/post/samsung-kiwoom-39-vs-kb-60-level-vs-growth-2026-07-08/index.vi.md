...
description: "Cùng một ngày, Kiwoom hạ mục tiêu Samsung xuống 390.000 KRW còn KB nâng lên 600.000. Trông có vẻ mâu thuẫn, nhưng qua các con số chúng không bác bỏ nhau. Kiwoom nói về sự giảm tốc của TỐC ĐỘ tăng lợi nhuận (đạo hàm bậc hai); KB nói về MỨC tuyệt đối. Cả hai đều đúng. Khoản dự phòng một lần ~17,6 nghìn tỷ KRW tách ra từ Q2 (OP điều chỉnh 107 vs báo cáo 89,4 nghìn tỷ), Q3 sạch +4,7% QoQ, sự giảm tốc từ Q2 sang Q3 theo TrendForce, và P/E 2026E ~6,7x tại giá đóng cửa 296.000 KRW — bài này giảm tối đa phán xét mua/bán và mổ xẻ lập luận và dữ liệu của cả hai báo cáo."
...
* **Một con số then chốt.** Chênh lệch giữa OP điều chỉnh Q2 của KB là 107 nghìn tỷ và OP báo cáo 89,4 nghìn tỷ ≈ một **khoản dự phòng một lần 17,6 nghìn tỷ KRW**. Bỏ méo mó nền đó ra, tiêu đề "Q3 +26%" rơi xuống khoảng **+4,7%** trên cơ sở sạch. "Giảm tốc" mà Kiwoom nói bằng lời đã nằm sẵn trong chính các con số của KB.
...
## 2. Mức vs tốc độ tăng — qua các con số, cả hai đều đứng vững

Một cổ phiếu giao dịch tốc độ thay đổi của lợi nhuận, không phải mức. Nên "lợi nhuận kỷ lục (mức)" và "đỉnh của gia tốc tăng (tốc độ)" có thể cùng đúng. Dùng chính các con số của KB làm rõ sự cùng tồn tại này.

Trước hết, tách khoản một lần. Trên cơ sở KB, OP điều chỉnh (sạch) Q2 là **107 nghìn tỷ** và OP báo cáo (kèm dự phòng thưởng) là **89,4 nghìn tỷ**. Chênh lệch là gánh nặng một lần dồn vào quý này.

* **Dự phòng một lần Q2 ≈ 107 − 89,4 = \~17,6 nghìn tỷ KRW**

Giờ đọc lại đường đi theo quý trên cơ sở **sạch với sạch**.

* **Q3 sạch QoQ ≈ 112 ÷ 107 = +4,7%**
* **Q4 sạch QoQ ≈ 124 ÷ 112 = +10,7%**

Tiêu đề "OP Q3 +26%" dùng báo cáo Q2 bị dự phòng đè xuống (89,4) làm mẫu số — một **ảo giác nền**. Bỏ dự phòng ra và động lượng QoQ thực của Q3 rơi xuống khoảng **+5%**. Tóm lại:

* **Mức lợi nhuận là kỷ lục** — quan sát của KB đứng vững.
* **Gia tốc tăng theo quý chậm lại mạnh ở Q3** — quan sát của Kiwoom đứng vững.
* Và trình tự (chậm ở Q3 → tăng tốc lại ở Q4) mới là câu chuyện thật.

Hai báo cáo không mâu thuẫn; chúng **nhìn vào các đạo hàm khác nhau (mức vs tốc độ thay đổi) của cùng một đường cong lợi nhuận.**
...
### [Inference]
* Q2 điều chỉnh 107 − báo cáo 89,4 ≈ dự phòng một lần 17,6; bỏ ra → Q3 sạch QoQ ≈ +4,7%, Q4 ≈ +10,7%.
* Tiêu đề "Q3 +26%" là ảo giác nền bị dự phòng đè; luận điểm giảm tốc của Kiwoom nằm sẵn trong con số KB.
