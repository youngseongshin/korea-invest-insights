...
**免責事項**：本稿はリサーチ目的のコメンタリーであり、投資助言ではありません。保有比率および資本構成の詳細は公開情報に基づくものであり、その後の資本イベントにより変動している可能性があります。掲載のティッカーはKビューティー投資フレームワークの例示目的であり、特定銘柄の推奨ではありません。投資判断は必ずご自身のデューデリジェンスのうえ、資格を有する専門家にご相談ください。
