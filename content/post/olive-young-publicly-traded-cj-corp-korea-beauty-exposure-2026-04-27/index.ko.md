...
**면책 고지**: 이 글은 리서치 해설로, 투자 권유가 아닙니다. 지분율 및 자본 구조 세부 내용은 공개 보도 기준이며, 이후 자본 이벤트로 변동됐을 수 있습니다. 언급된 티커는 K-뷰티 투자 프레임워크 설명을 위한 예시이며, 매수 추천이 아닙니다. 투자 결정 전 반드시 직접 조사하고 전문 투자 자문가와 상담하십시오.
