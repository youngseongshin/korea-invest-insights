---
title: "Olive Young est-elle cotée en bourse ? CJ Corp, CJ CheilJedang et comment s'exposer vraiment à la K-Beauty"
slug: olive-young-publicly-traded-cj-corp-korea-beauty-exposure-2026-04-27
date: 2026-04-27T22:00:00+09:00
description: "Olive Young n'est pas cotée en bourse. Le meilleur proxy indirect est CJ Corporation (000120.KS), qui détient ~51,2 % de CJ Olive Young. CJ CheilJedang est une entité agroalimentaire distincte et ne constitue pas un vecteur direct d'exposition à la K-beauty. Valeurs cotées mieux positionnées : AmorePacific (090430.KS), LG H&H (051900.KS), Cosmax (192820.KS), Kolmar Korea (161890.KS), COSRX (désormais sous Kolmar BNH). Cartographie complète de l'actionnariat, historique d'introduction en bourse et cadre d'exposition en 5 catégories."
categories: ["Marché coréen", "Consommation", "K-Beauty"]
tags: ["olive-young", "cj-olive-young", "cj-corporation", "000120", "cj-cheiljedang", "korea-beauty", "k-beauty", "amorepacific", "lg-hh", "cosmax", "kolmar-korea", "cosrx", "introduction-en-bourse", "société-non-cotée"]
---
...
- Le meilleur **proxy indirect** est **CJ Corporation (000120.KS)** — la holding qui détient environ **51,2 %** de CJ Olive Young. Les enfants du président Lee Jay-hyun détiennent directement environ **\~22 %** supplémentaires, le reste étant aux mains d'investisseurs financiers depuis un tour de table pré-IPO en 2021.
...
| Élément | Valeur |
|---|---|
| Dénomination légale | CJ Olive Young Corp. (CJ 올리브영 주식회사) |
| Groupe actionnaire ultime | CJ Group |
| Actionnaire direct (contrôle) | CJ Corporation (000120.KS) |
...
## 3. Le meilleur proxy indirect : CJ Corporation (000120.KS)
...
```text
Exposition effective à Olive Young par ₩ investie dans CJ Corp
= Participation de CJ Corp dans OY (~51,2 %)
  × votre participation dans CJ Corp
  × (1 − décote holding)
```
...
|---|---|---|---|
| Cotée ? | Oui (000120.KS) | Oui (097950.KS) | **Non** |
...
## 5. Historique de l'IPO d'Olive Young — Pourquoi elle n'a pas eu lieu
...
### Catégorie C — Sous-traitance ODM / Chaîne de fabrication
...
- **CJ Corporation (000120.KS)** — le proxy holding Olive Young lui-même.

### Cadre de décision rapide

| Votre objectif | Meilleure approche |
|---|---|
| Potentiel pur Olive Young | **CJ Corporation (000120.KS)** + accepter la décote holding, surveiller le catalyseur IPO |
...
| Panier K-beauty diversifié | Pondération égale AmorePacific, LG H&H, Cosmax, Kolmar Korea + petite ligne CJ Corp |

---

## 7. Le profil opérationnel d'Olive Young — Pourquoi cet actif suscite autant d'intérêt
...
## 8. Les risques du pari "Acheter CJ Corp pour s'exposer à Olive Young"
...
- Si vous visez **Olive Young spécifiquement**, votre seul accès public est **CJ Corporation (000120.KS)** — acceptez la décote holding, suivez le calendrier d'IPO, considérez la position comme un combo Value-Up + catalyseur IPO.
...
En attendant, la réponse la plus claire à la recherche en anglais est celle par laquelle nous avons commencé : **Non, Olive Young n'est pas cotée en bourse. La façon la plus proche d'y accéder reste CJ Corporation (000120.KS).**

---

## Annexe — Niveau de fiabilité des informations

### [Fait]

- CJ Olive Young n'est cotée sur aucune bourse.
- CJ Olive Young a été scindée de CJ Olive Networks en 2019.
- CJ Corporation est l'actionnaire de contrôle de CJ Olive Young.
- Lee Sun-ho et Lee Kyung-hoo (enfants du président Lee Jay-hyun) détiennent des participations minoritaires directes dans CJ Olive Young.
- Un dossier de cotation au KOSPI pour CJ Olive Young a été retiré en 2022.
- CJ CheilJedang (097950.KS) est une entité cotée distincte, dont les activités relèvent de l'agroalimentaire et de la biotechnologie, sans participation directe dans CJ Olive Young.
- AmorePacific (090430.KS), LG H&H (051900.KS), Cosmax (192820.KS), Kolmar Korea (161890.KS) et Kolmar BNH (200130.KS) sont cotées.

### [Inférence]

- La valorisation privée implicite de CJ Olive Young est matériellement supérieure à la fourchette de l'IPO avortée de 2022, portée par la croissance du chiffre d'affaires et l'expansion des marges post-COVID.
- La décote holding coréenne sur CJ Corporation a historiquement oscillé entre 30 et 50 %, limitant la transmission de la valeur sous-jacente d'Olive Young aux actionnaires cotés de CJ Corp.
- Une nouvelle fenêtre d'IPO pour Olive Young — que ce soit en 2026, 2027 ou plus tard — constituerait un catalyseur de reconnaissance de VAN pour CJ Corp.
- Les ODMs (Cosmax, Kolmar Korea) captent les effets économiques de la vague K-beauty avec un risque monoмарque plus faible que les marques patrimoniales.

### [Spéculation]

- La participation directe de \~11 % de Lee Sun-ho dans CJ Olive Young est une incitation structurelle pour la famille / le groupe à monétiser via une IPO + cession secondaire.
- Une IPO Olive Young réussie à une valorisation nettement supérieure à celle de 2022 pourrait déclencher une compression de la décote holding chez CJ Corp au-delà de ce que la seule arithmétique de VAN justifierait.

### [Non confirmé]

- Tableau de répartition du capital de CJ Olive Young à jour (les derniers ajustements de la participation des investisseurs financiers ne sont pas toujours intégralement divulgués publiquement).
- Toute date de dépôt d'IPO confirmée en 2026.
- Niveaux précis de marge brute et de marge opérationnelle des lignes de marques propres de CJ Olive Young.
