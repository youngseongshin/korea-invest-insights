...
description: "Olive Young 尚未上市。最直接的间接替代标的是 CJ Corporation（000120.KS），持有 CJ Olive Young 约 51.2% 的股份。CJ CheilJedang 是独立的食品业务主体，与韩妆没有直接关联。更贴近韩妆赛道的上市标的包括：爱茉莉太平洋（090430.KS）、LG H&H（051900.KS）、科玛仕（192820.KS）、韩国科玛（161890.KS）、COSRX（现归属 Kolmar BNH 旗下）。本文完整梳理股权结构、IPO 历史，并提供五类布局框架。"
categories: ["韩国市场", "消费", "韩妆"]
tags: ["olive-young", "cj-olive-young", "cj-corporation", "000120", "cj-cheiljedang", "韩国美妆", "k-beauty", "爱茉莉太平洋", "lg-hh", "cosmax", "kolmar-korea", "cosrx", "ipo", "非上市公司"]
---

## 核心结论

- **Olive Young 尚未上市。** 它是 CJ 集团旗下的非上市子公司，正式名称为 **CJ Olive Young Corp.**，于 2019 年从 CJ Olive Networks 分拆独立。
- 最直接的**间接替代标的**是 **CJ Corporation（000120.KS）** —— 该控股公司持有 CJ Olive Young 约 **51.2%** 的股份。李氏家族（董事长 Lee Jay-hyun 的子女）另持有约 **~22%** 的直接股份，其余由 2021 年 Pre-IPO 轮次引进的财务投资人持有。
...
- 如果你想要**专属 Olive Young 的敞口**，唯一的公开市场路径是 **CJ Corporation（000120.KS）** —— 接受控股折价、追踪 IPO 时间线，将该持仓定性为"Value-Up＋IPO 催化剂"的组合逻辑。
...
**免责声明**：本文为研究性评论，不构成投资建议。持股比例及资本结构信息均基于公开披露数据，可能随后续资本事件发生变动。文中所提股票代码仅用于韩妆赛道布局框架的说明，不构成投资推荐。在作出任何投资决策前，请进行独立尽职调查，并咨询持牌专业顾问。
