...
> 📚 Series Hyundai Mobis / Robotics
> Bài trước: [Hyundai Mobis — Gã Khổng Lồ Linh Kiện EV Bước Vào Robotics (Phân tích sâu 28/4)](/post/kr-deep-dive-hyundai-mobis-2026-04-28/)
> Bản đồ chuỗi giá trị robotics Hàn Quốc: [Bản Đồ Hoàn Chỉnh Chuỗi Giá Trị Robotics Hàn Quốc (11/5)](/post/korea-robotics-value-chain-complete-map-2026-05-11/)
> So sánh linh kiện robot: [SPG vs Halla Cast — So Sánh Linh Kiện Robot (12/5)](/post/spg-vs-halla-cast-robot-component-comparison-2026-05-12/)
> So sánh OEM humanoid: [Robotis vs Rainbow Robotics (12/5)](/post/robotis-vs-rainbow-robotics-humanoid-comparison-2026-05-12/)
...
## 1. Dữ Kiện và Cấu Trúc

### 1.1 Các Dữ Kiện Cốt Lõi
...
## 2. Bản Đồ Chuỗi Giá Trị

### 2.1 Vị Trí Của Hyundai Mobis Trong Chuỗi Giá Trị Robot

```text
AI Vật Lý / Mô Hình Nền Tảng
        ↓
Robot OS / Lập Kế Hoạch Nhiệm Vụ / Điều Khiển
        ↓
Cảm Biến / Camera / Nhận Thức
        ↓
Bộ Điều Khiển / Điện Tử Công Suất / Pin
        ↓
Actuator / Hộp Giảm Tốc / Động Cơ / Gripper
        ↓
...
| Biến số | Ý nghĩa | Tầm quan trọng đầu tư |
| --- | --- | ---: |
| Cung cấp toàn bộ actuator | Xác định hàm lượng Mobis trên mỗi đơn vị | Rất cao |
| Mở rộng sang gripper / cảm biến / bộ điều khiển | Tăng doanh thu trên mỗi đơn vị | Cao |
| Hợp đồng với khách hàng ngoài HMG | Chuyển từ nhà cung cấp nội bộ sang nền tảng toàn cầu | Rất cao |

---

## 3. Ước Tính Doanh Thu Với 30K Đơn Vị Atlas
...
## 4. Tính Toán Lợi Nhuận Hoạt Động và Giá Trị Phân Khúc
...
| ---: | ---: | ---: | ---: |
| $30.000 | KRW 1,35 nghìn tỷ | KRW 108 tỷ | KRW 162 tỷ |
| $40.000 | KRW 1,80 nghìn tỷ | KRW 144 tỷ | KRW 216 tỷ |
| $50.000 | KRW 2,25 nghìn tỷ | KRW 180 tỷ | KRW 270 tỷ |
...
Áp dụng bội số của công ty thuần robot cho toàn bộ tập đoàn Mobis là quá tích cực. Mảng kinh doanh cốt lõi vẫn là linh kiện ô tô + A/S tạo tiền; linh kiện robot chưa có lịch sử lợi nhuận độc lập.

| Tài sản | Bội số hợp lý | Nhận xét |
| --- | ---: | --- |
| Linh kiện ô tô truyền thống / A/S | P/E 11–13x | A/S tiền mặt ổn định xứng đáng được định giá cao hơn |
| Mobis tổng hợp | P/E 14–16x | Mức trần nếu tính phần quyền chọn robot |
...
| ---: | ---: | ---: | ---: | ---: |
| $30.000 | KRW 108 tỷ | KRW 2,16 nghìn tỷ | KRW 162 tỷ | KRW 3,24 nghìn tỷ |
| $40.000 | KRW 144 tỷ | KRW 2,88 nghìn tỷ | KRW 216 tỷ | KRW 4,32 nghìn tỷ |
| $50.000 | KRW 180 tỷ | KRW 3,60 nghìn tỷ | KRW 270 tỷ | KRW 5,40 nghìn tỷ |
...
## 5. Bao Nhiêu Giá Trị Quyền Chọn Robot Đã Được Tính Vào Giá?

### 5.1 Tính Ngược Từ Mức Giá Hiện Tại
...
| ---: | ---: | ---: | ---: |
| 11x | KRW 507.000 | KRW 122.000 | \~KRW 10,9 nghìn tỷ |
| 12x | KRW 553.000 | KRW 76.000 | \~KRW 6,8 nghìn tỷ |
| 13x | KRW 599.000 | KRW 30.000 | \~KRW 2,7 nghìn tỷ |
| 14x | KRW 645.000 | âm | Mảng truyền thống tự giải thích được mức giá |
...
| --- | ---: |
| Bi quan | KRW 2,2–3,2 nghìn tỷ |
| Cơ sở | KRW 3,6–5,4 nghìn tỷ |
...
| Yếu tố | Tại sao quan trọng | Chất xúc tác cần theo dõi |
| --- | --- | --- |
| Cung cấp gripper | Phần BOM lớn nhất sau actuator | Hợp đồng cung cấp bổ sung của Mobis |
| Mở rộng cảm biến / bộ điều khiển | Tăng hàm lượng trên mỗi đơn vị | Công bố danh mục linh kiện robot |
| Khách hàng ngoài HMG | Chuyển từ nhà cung cấp nội bộ sang nền tảng toàn cầu | Khách hàng ngoài Boston Dynamics |
| Giá trị cổ phần Boston Dynamics | Tiếp xúc gián tiếp 10,9% qua Hyundai Global | Đầu tư bên ngoài / IPO / giao dịch BD |
| Khối lượng lớn 2035 | Hàng chục hoặc hàng trăm nghìn robot, không phải 30K | Kinh tế học đơn vị được kiểm chứng |

KB Securities định vị Mobis là trung tâm của chuỗi cung ứng hỗ trợ sản xuất của Boston Dynamics, với việc cung cấp toàn bộ actuator và đàm phán cung cấp gripper đang tiến hành.
...
### 7.3 Điều Kiện Để Vào Lệnh

Vào lệnh mới hợp lý hơn khi ít nhất hai trong số các điều kiện sau được xác nhận:

1. Khối lượng cung cấp actuator Atlas được định lượng.
2. Hàm lượng Mobis trên mỗi đơn vị hoặc hướng dẫn doanh thu linh kiện robot hàng năm được công bố.
3. Các linh kiện ngoài actuator (gripper, cảm biến, bộ điều khiển) được đưa vào phạm vi cung cấp.
4. Một khách hàng ngoài HMG được xác nhận.
5. OPM linh kiện robot được chứng minh cao hơn mảng module truyền thống.

### 7.4 Các Trường Hợp Phủ Nhận Luận Điểm

Luận điểm tái định giá robot suy yếu khi xảy ra bất kỳ điều nào sau:

* Triển khai Atlas tại HMGMA bị trì hoãn sang sau năm 2028.
* Ứng dụng tại nhà máy dừng ở quy mô thử nghiệm mà không có ROI năng suất được kiểm chứng.
* Phạm vi cung cấp của Mobis bị giới hạn ở một phần actuator.
* Vấn đề về năng suất / độ bền linh kiện robot trong quá trình ramp-up sản xuất.
* Thua lỗ từ Module / Linh kiện Cốt lõi kéo dài trong khi biên lợi nhuận cao của A/S chuẩn hóa về mức bình thường.
* Boston Dynamics thất bại trong việc giành thị phần có ý nghĩa bên ngoài hệ sinh thái HMG.
