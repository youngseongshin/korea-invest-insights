...
> 📚 Serie Hyundai Mobis / Robótica
> Anterior: [Hyundai Mobis — El gigante de componentes EV que impulsa la robótica (análisis profundo del 28 de abril)](/post/kr-deep-dive-hyundai-mobis-2026-04-28/)
> Mapa de la cadena de valor de robótica en Corea: [Mapa completo de la cadena de valor robótica de Corea (11 de mayo)](/post/korea-robotics-value-chain-complete-map-2026-05-11/)
> Comparativa de componentes robóticos: [SPG vs Halla Cast — Comparativa de componentes robóticos (12 de mayo)](/post/spg-vs-halla-cast-robot-component-comparison-2026-05-12/)
> Comparativa de OEMs humanoides: [Robotis vs Rainbow Robotics (12 de mayo)](/post/robotis-vs-rainbow-robotics-humanoid-comparison-2026-05-12/)
...
1. Los volúmenes de suministro de actuadores para Atlas quedan cuantificados.
2. Mobis divulga el contenido por unidad o una guía de ingresos anuales por componentes robóticos.
3. Los componentes no-actuador (grippers, sensores, controladores) entran en el alcance de suministro.
4. Se confirma un cliente externo fuera de HMG.
5. Se demuestra que el margen operativo de los componentes robóticos supera al del negocio de módulos tradicional.
