...
Comparación de los [escenarios previos](/post/us-china-summit-korea-investor-guide-2026-05-14/) con el resultado real:
...
| Cosmética / turismo | Expectativa de apertura China → positivo indirecto | No descontado | Seguimiento |
...
| Mensaje del análisis previo | Resultado |
|---|---|
...
| Mensaje del análisis previo | Revisión |
|---|---|
