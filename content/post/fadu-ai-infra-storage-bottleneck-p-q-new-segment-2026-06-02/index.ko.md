---
title: "메모리를 이길 수 있는 AI 인프라 병목은 어디일까: 파두는 P와 Q와 새 세그먼트를 같이 열 수 있을까?"
date: 2026-06-02T22:35:00+09:00
description: "파두를 AI eSSD 컨트롤러 병목으로 보고, 메모리보다 오래 갈 수 있는 AI 인프라 투자 조건을 P(단가), Q(물량), C(비용), 새 세그먼트 확장으로 검증한다. 2Q26 매출 900억~1,050억원, 외국인·프로그램 수급, Gen5·Gen6·PMIC·CXL 옵션을 함께 점검한다."
