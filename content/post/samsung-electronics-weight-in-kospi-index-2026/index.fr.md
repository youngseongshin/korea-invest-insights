---
title: "Le poids de Samsung Electronics dans le KOSPI : concentration de l'indice en 2026"
slug: samsung-electronics-weight-in-kospi-index-2026
date: 2026-04-27T20:30:00+09:00
description: "Quelle part du KOSPI représente Samsung Electronics ? Un guide pratique 2026 pour les investisseurs internationaux sur la pondération de Samsung dans l'indice, la concentration du KOSPI, le KOSPI 200, le MSCI Korea, l'EWY et les ETF Corée."
categories: ["Marché Coréen", "Chaîne d'approvisionnement tech Corée"]
...
| Mouvement Samsung | Impact direct approximatif sur EWY avant autres positions et FX |
|---:|---:|
...
| Régime | Ce que fait la concentration |
|---|---|
| Révision à la hausse des résultats mémoire IA | La concentration amplifie la hausse |
| Affaiblissement du KRW + expansion des marges exportateurs | Samsung peut amortir les cycliques domestiques |
| Déception sur les prix HBM / DRAM | Le bêta Corée peut se déprécier rapidement |
| Reprise domestique large | Le KOSPI peut progresser même si Samsung est en retrait, mais l'indice a besoin d'ampleur |
| Flux passifs étrangers entrants | Samsung et SK Hynix reçoivent souvent les flux de premier ordre |
| Rotation sectorielle hors semiconducteurs | La performance au niveau de l'indice peut masquer des opportunités sectorielles |
...
| Objectif investisseur | Instrument préférable | Pourquoi |
|---|---|---|
| Exposition Corée simple cotée aux États-Unis | EWY | Accès facile, liquide, mais concentration Samsung + Hynix élevée |
| Dérivés / couverture Corée domestiques | Futures ou ETF KOSPI 200 | Benchmark local le plus pertinent |
| Thèse pure sur Samsung | Achat direct de 005930.KS | Conviction maximale sans panier Corée non lié |
| Angle décote droits de vote Samsung | Comparer 005930 et actions préférentielles | Les préférentielles peuvent se comporter différemment des ordinaires |
| Thèse sur l'ampleur du marché coréen | Panier de titres ou approche équipondérée | Réduit la dominance Samsung/Hynix |
| Thèse macro mémoire IA Corée | Panier Samsung + SK Hynix | Plus propre qu'un ETF Corée large si c'est la vraie conviction |
| Thèse gouvernance / value-up Corée | Financières, holdings, industriels sélectionnés | Moteur de performance différent du cycle HBM Samsung |
...
- [iShares MSCI South Korea ETF (EWY)](https://www.ishares.com/us/products/239681/ishares-msci-south-korea-capped-etf) : objectif du fonds et page officielle des positions ; les positions sont susceptibles de changer.
- [Positions EWY sur StockAnalysis](https://stockanalysis.com/etf/ewy/holdings/) : instantané des positions EWY montrant Samsung Electronics à 22,68 % et SK Hynix à 21,99 % au 24 avril 2026.
- [Indice MSCI Korea](https://www.msci.com/indexes/index/941000) : composition de l'indice MSCI Korea et principaux composants au 31 mars 2026.
- [Indice MSCI Korea 25/50](https://www.msci.com/indexes/index/702747) : résumé de la méthodologie de l'indice plafonné et principaux composants au 31 mars 2026.
- [S&P Dow Jones Indices / KRX comparaison](https://www.spglobal.com/spdji/en/documents/education/education-why-does-the-sp-500-matter-to-korea.pdf) : concentration du KOSPI 200 et pondérations des principaux composants au 30 septembre 2025.
