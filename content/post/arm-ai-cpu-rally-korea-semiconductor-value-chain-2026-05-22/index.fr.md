...
Le catalyseur externe a été NVIDIA. La société a publié un chiffre d'affaires trimestriel de **81,6 milliards de dollars**, un chiffre d'affaires Data Center de **75,2 milliards**, et une guidance Q2 de **91,0 milliards ±2%**. Le marché y a vu une accélération de la demande IA, non un pic de cycle. ([NVIDIA][1])

L'histoire propre d'ARM est solide. FY26 : chiffre d'affaires **4,92 milliards de dollars**, redevances **2,61 milliards**, licences **2,31 milliards**, EPS non-GAAP **1,77 dollar**. Arm AGI CPU est présenté comme une plateforme CPU de centre de données IA, avec Meta comme partenaire principal; la demande client FY27-FY28 dépasse déjà **2 milliards de dollars**. ([Arm][2])

Le problème est le prix. Research OS local DB indique qu'ARM a clôturé le 21 mai 2026 à **298,23 dollars**. Rapporté à l'EPS non-GAAP FY26, cela donne environ **168,5x** les bénéfices. La thèse est juste, mais l'action n'est pas bon marché.
...
ARM a placé **Arm AGI CPU** au centre de son récit. L'entreprise le décrit comme un produit silicium pour centres de données agentic AI, avec Meta comme partenaire de référence. Des systèmes commerciaux peuvent être commandés via ASRock, Lenovo, Quanta et Supermicro. ([Arm][2])
...
À **298,23 dollars**, avec un EPS non-GAAP FY26 de **1,77 dollar** :

```text
PER non-GAAP FY26 = 298,23 / 1,77 = environ 168,5x
```

Avec un chiffre d'affaires FY26 de **4,92 milliards**, la capitalisation dans la zone basse des 300 milliards implique un multiple ventes supérieur à 60x.
...
Notre lecture : **ne pas poursuivre au prix actuel / attendre**.

---

## 4. Alpha 1 : Marvell et le goulot de connectivité

Si ARM représente l'orchestration CPU, Marvell représente **compute sur mesure + optique + switching**.

Marvell a publié un chiffre d'affaires FY26 de **8,195 milliards de dollars** et un EPS non-GAAP de **2,84 dollars**. La société prévoit un FY27 proche de 11 milliards, avec la data center en moteur de croissance et une hausse de plus de 50% des revenus d'interconnexion. ([Marvell][4])
...
Mais MRVL a déjà fortement monté. Research OS local DB indique une clôture à **190,69 dollars** le 21 mai 2026. Lecture : **attendre / acheter sur repli**.
...
Le 20 mai 2026, la société a annoncé un contrat de condensateurs au silicium d'environ **1,5 billion de wons** sur deux ans. Ces composants sont installés dans des packages hautes performances comme les GPU IA et la HBM afin de stabiliser l'alimentation. ([Samsung Electro-Mechanics][6])
...
La règle : **ne pas acheter seulement le mot IA; acheter clients, commandes et marges vérifiés.**
...
**ARM est le signal. L'alpha est dans les goulots.**
