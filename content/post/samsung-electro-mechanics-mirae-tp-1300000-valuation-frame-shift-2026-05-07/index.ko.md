...
2026년 EPS가 아니라 2028년 EPS를 쓰면 이익 기준점이 크게 커진다. 여기에 37배를 곱하면 단순 실적 상향이 아니라 **평가 방식 자체의 변경**이 된다.
...
그래서 이 리포트는 "목표가 130만원"보다 **조건부 리레이팅 프레임**으로 읽는 편이 낫다.
...
핵심 구분은 **실제 쇼티지**와 **가격에 반영된 쇼티지**다. 둘은 동시에 존재할 수 있다. 회사의 AI 부품 사이클은 강하지만, 주가는 이미 그 상당 부분을 반영했을 수 있다.
