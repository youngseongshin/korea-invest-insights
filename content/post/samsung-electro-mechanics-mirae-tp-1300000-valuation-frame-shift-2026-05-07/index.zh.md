...
这与其说是一次普通的盈利上调，不如说是一次<strong>估值框架的切换</strong>。核心争议在于：三星电机究竟还是一家周期性电子元件公司，还是已因AI服务器MLCC和FC-BGA需求，跃升为AI基础设施瓶颈标的？
...
这正是为何本文应被理解为一个<strong>有条件的估值框架重构</strong>，而非简单的目标价认可。
...
最核心的区分在于：<strong>真实短缺</strong>与<strong>已被定价的短缺</strong>。两者可以同时为真——公司可以处于强劲的AI元件周期中，而股价已对其中大部分提前定价。
