...
그래서 이 비교의 핵심은 "누가 1분기에 더 잘했나"가 아니다. **그 이익이 얼마나 반복될 수 있나**다.
...
두 회사의 차이를 가장 짧게 표현하면 이렇다. 하나마이크론은 **가격 구조가 바뀌었는가**를 봐야 하고, 제주반도체는 **공급 부족이 얼마나 오래 가는가**를 봐야 한다.
...
하나마이크론은 **구조 개선**이다. Vina 법인의 원가 연동 단가 구조, 브라질 법인의 high-teens 마진, SK하이닉스향 후공정 물량 증가가 함께 움직였다. 1Q 마진을 그대로 정상화할 수는 없지만, 과거보다 높은 이익 체력을 만들 가능성이 있다.

제주반도체는 **사이클 피크**에 가깝다. LPDDR4X 공급 부족과 관세 우려 선주문이 만든 초과마진이다. 회사의 제품화 능력과 니치 시장 대응력은 인정해야 하지만, 37.2% 영업이익률을 정상 마진으로 보면 위험하다.
