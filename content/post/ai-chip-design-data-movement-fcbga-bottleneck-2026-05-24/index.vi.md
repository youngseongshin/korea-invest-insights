...
Điểm mấu chốt rất đơn giản. Hiệu năng AI không chỉ phụ thuộc vào FLOPS. Nút thắt cổ chai thực sự là **dữ liệu đến từ đâu, được lưu trữ ở đâu, và con đường giữa bộ nhớ và tính toán ngắn đến mức nào**. Với khung nhìn đó, NVIDIA vẫn là trung tâm, nhưng luận điểm đầu tư lan rộng sang HBM, substrate đóng gói, FC-BGA, PCB nhiều lớp, Ethernet, kết nối quang, linh kiện ổn định nguồn và kiểm thử.

Với nhà đầu tư Hàn Quốc, hướng đọc rất rõ ràng. **Samsung Electronics và SK Hynix là lõi bộ nhớ. Samsung Electro-Mechanics là nút FC-BGA và ổn định nguồn bằng tụ silicon. Daeduck, Isu Petasys, Simmtech, Korea Circuit và TLB là các cổ phiếu phân tán trong substrate và PCB.** Đây không phải thị trường để đuổi theo khoảng gap thứ Hai. Điều then chốt là liệu khối lượng giao dịch và dòng tiền ngoại/tổ chức có duy trì đến buổi chiều hay không.
...
Phần lớn tính toán AI là phép nhân ma trận lặp đi lặp lại: nhân nhiều số, cộng lại, rồi làm lại. Làm cho đơn vị số học nhanh hơn là quan trọng, nhưng ở cấp độ chip, câu hỏi lớn hơn thường là **những con số đó đến từ đâu**.
...
Nếu đơn vị số học phải chờ dữ liệu, chip bị sử dụng kém hiệu quả. Vậy câu hỏi thực sự về chip AI không chỉ là "có thể thêm nhiều tính toán hơn không?" Mà là **"có thể di chuyển ít dữ liệu hơn, giữ nó gần hơn, và nuôi chip mà không lãng phí điện không?"**

Đó là lý do tại sao HBM, FC-BGA, tụ silicon và PCB tốc độ cao cùng thuộc một cuộc thảo luận. Tất cả đều giải quyết cùng một vấn đề vật lý: **giữ cho chip AI được cung cấp dữ liệu và nguồn điện ổn định**.
...
NVIDIA công bố doanh thu Q1 FY27 là **$81,6 tỷ**, doanh thu Data Center là **$75,2 tỷ**, và hướng dẫn doanh thu Q2 là **$91,0 tỷ ±2%**. Theo số liệu chính thức, nhu cầu hạ tầng AI chưa hạ nhiệt.[^nvidia]
...
Tập All-In thuộc về nhóm này. Anthropic, Karpathy, SpaceX, thu nhập NVIDIA và quy định AI đều là một phần của vấn đề lớn hơn: **AI chưa kết thúc, nhưng giờ phải chứng minh hiệu quả sử dụng vốn**.[^allin]
...
Marvell và Broadcom là các sự kiện thu nhập tiếp theo cần theo dõi trong khung này. Cả hai đều không đơn giản là "đối thủ cạnh tranh NVIDIA." Khi data center AI mở rộng quy mô, cả hai gắn vào **kết nối, chuyển mạch, tín hiệu quang và silicon AI tùy chỉnh**.
...
Cách đọc đúng không phải "Broadcom / Marvell tốt nghĩa là tất cả bán dẫn Hàn Quốc đều tốt." Mà là: **tăng trưởng chip AI mang lại lợi ích cho các nhà cung cấp nút thắt nuôi, kết nối, ổn định và kiểm thử những chip đó.**
...
Điểm mấu chốt không phải tên khách hàng. Điểm mấu chốt là **công suất substrate AI hiện đang được mở rộng theo các thỏa thuận dài hạn**.
...
Điểm mấu chốt không phải "nhiều nội dung MLCC hơn." Điểm mấu chốt là Samsung Electro-Mechanics có thể được phân loại lại thành **công ty substrate có linh kiện ổn định nguồn trong gói đóng gói**.
...
Cụm từ "tiếp xúc server AI" là chưa đủ. Bằng chứng nhà đầu tư cần là **cung cấp trực tiếp, ASP tăng, thỏa thuận dài hạn và khả năng phục hồi biên lợi nhuận**.
...
Vậy bài học từ 20VC không phải "mua tiếp xúc AI tư nhân." Mà là: **khẩu vị rủi ro AI vẫn còn sống, nhưng thị trường sẽ ngày càng đòi hỏi bằng chứng kiếm tiền và dòng tiền.**
...
**Thương vụ AI chưa kết thúc. Nó đang chuyển xuống theo chuỗi.**
...
1. **Lõi bộ nhớ:** Samsung Electronics, SK Hynix
2. **Đóng gói và ổn định nguồn:** Samsung Electro-Mechanics, Daeduck Electronics
3. **PCB tốc độ cao và module:** Isu Petasys, Simmtech, Korea Circuit, TLB
4. **Kiểm thử và socket:** ISC, LEENO Industrial, TSE
5. **Điện và vận hành data center:** thiết bị điện và hạ tầng làm mát

Câu đầu tư quan trọng nhất là: **cạnh tranh hiệu năng AI là cạnh tranh chi phí di chuyển dữ liệu, và chi phí đó dịch chuyển thành HBM, đóng gói, substrate, mạng và nguồn điện.**
