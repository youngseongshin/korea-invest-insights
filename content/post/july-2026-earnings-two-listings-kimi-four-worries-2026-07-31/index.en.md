---
title: "The AI Demand Was Real, and the Bill Went to Memory: A July Earnings Season Wrap"
...
July's prices asked the question of 1999, and July's earnings answered with 1996. Growth rates accelerated, backlogs piled up, and everyone talked about a supply shortfall. But earnings also delivered a new rule. Capital expenditure is no longer a matter of faith; it has become a test graded quarter by quarter, and memory pricing, the grading criterion for that test, appeared for the first time this quarter as a cost line on income statements worldwide. That the supercycle's profits are real, and that the durability of those profits is re-examined every quarter: these are the two sentences July leaves behind.

</div>

## 1. A Map of July's Events
...
<figcaption><strong>The July event map.</strong> The declines (the Kimi shock, Black Tuesday) came before the earnings; the record rebound came after them. July 31 figures are intraday.</figcaption>
</figure>
...
## 3. Capex's New Grammar: A Scorecard
...
<figcaption><strong>The capex scorecard.</strong> The size of the number had nothing to do with the reaction; same-quarter revenue proof did. Microsoft's $175bn is the calendar-2026 figure after the accounting reclassification.</figcaption>
<details class="kii-figure__table"><summary>View as table</summary>
...
## 4. Memory's Two-Sided Earnings: A Cost Line Appears
...
## 5. Two Listings: Capital's Great Migration
...
## 6. Kimi K3 and the Fork in Frontier-Lab Profitability
