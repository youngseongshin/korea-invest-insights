---
title: "Hub d'analyse exclusive : écrans propriétaires et flux du marché coréen"
...
| Date | Sujet | Lire |
|---|---|---|
| 2026-07-19 | Rapport hebdomadaire approfondi sur les semi-conducteurs | [TSMC, ASML et les prix mémoire confirment une demande physique solide en 2026-2027, tandis que les mêmes plans de capacité préparent une réponse de l'offre en 2028. Le scénario central combine des bénéfices élevés et des multiples plus bas, à vérifier par les prix contractuels, le BPA 2028, la rentabilité de l'IA et la force relative](/fr/post/weekly-semiconductor-deep-dive-strong-earnings-lower-multiple-2028-pivot-2026-07-19/) |
| 2026-07-17 | Lettre de la Chambre américaine sur l'achat de mémoire chinoise | [Il ne s'agit pas encore d'une réglementation, mais d'une demande bipartisane visant à renforcer les contrôles sur YMTC, accélérer l'examen de CXMT et limiter les achats pour l'IA, les data centers et les infrastructures critiques. L'effet majeur serait de réduire la décote liée au risque de surcapacité chinoise en 2027-2028](/fr/post/us-house-chinese-memory-procurement-ban-cxmt-ymtc-cycle-impact-2026-07-17/) |
...
| 2026-07-08 | Samsung 2T26: signaux et bruit | [Le bénéfice opérationnel de 89,4 billions de wons renforce la thèse, mais les flux étrangers, les taux, ASML et TSMC imposent d'attendre avant de renforcer](/fr/post/samsung-record-quarter-profit-signals-noise-2026-07-08/) |
| 2026-07-04 | Dukovany et l'accord Westinghouse | [Le risque de contrat baisse, mais le vrai test devient les péages Westinghouse, la localisation, le prix fixe, le calendrier et les marges](/fr/post/dukovany-westinghouse-ip-settlement-korea-nuclear-margin-risk-2026-07-04/) |
...
- [La divergence des infrastructures d’inférence agentique aux États-Unis et en Chine, et l’opportunité SRAM](/fr/post/us-china-agentic-inference-stack-sram-opportunity-2026-07-09/)
...
- [La valeur actuelle et future du token IA: valeur ajoutée des acteurs de la mémoire](/fr/post/ai-token-value-memory-value-added-2026-07-09/)
- [Samsung 2T26: signaux et bruit après un bénéfice opérationnel de taille record](/fr/post/samsung-record-quarter-profit-signals-noise-2026-07-08/)
...
- [Dukovany et l'accord Westinghouse: le risque de contrat baisse, le risque de marge reste](/fr/post/dukovany-westinghouse-ip-settlement-korea-nuclear-margin-risk-2026-07-04/)
