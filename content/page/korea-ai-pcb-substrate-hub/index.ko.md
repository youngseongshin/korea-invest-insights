...
| 9 | 빅테크 AI 투자지출은 한국 공급망에 어떻게 전달되나 | [삼성전자 vs 삼성전기: 빅테크 AI 투자 재가속](/ko/post/bigtech-1q26-samsung-electronics-vs-electro-mechanics-2026-04-30/) |
| 10 | 클러스터 11번째 종목, 리드프레임에서 AI 방열부품으로 가는 unique angle | [해성디에스: 자동차 LF에서 AI Heat Spreader second-source까지](/ko/post/haesung-ds-leadframe-ai-heat-spreader-second-source-2026-05-07/) |
| 11 | AI 데이터센터의 다음 병목 — 광통신·CPO 7개사 중 진짜는 누구인가 | [한국 광통신·CPO 밸류체인 7개사 — 진짜 가까운 회사는 오이솔루션 하나뿐](/ko/post/korea-optical-cpo-value-chain-seven-companies-2026-05-09/) |
| 12 | 같은 'AI 후공정 수혜주'라도 기판과 테스트 소켓을 같이 묶으면 안 되는 이유 | [기판 vs 테스트 소켓: AI 후공정 두 가지 베타](/ko/post/ai-substrate-vs-test-socket-comparison-2026-05-15/) |
