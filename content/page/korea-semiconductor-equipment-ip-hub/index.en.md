...
| Can FADU become an AI infrastructure bottleneck that beats memory? | It can, but only if P, Q, C and a new segment open together. The next proof points are Q2 2026 revenue of KRW 90-105bn, controller mix, Gen6 / PMIC / CXL options, and a cleaner flow turn beyond program buying. | [FADU P, Q and new-segment check](/post/fadu-ai-infra-storage-bottleneck-p-q-new-segment-2026-06-02/) |
